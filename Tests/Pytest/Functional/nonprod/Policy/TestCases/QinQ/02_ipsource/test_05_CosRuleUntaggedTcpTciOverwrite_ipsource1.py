...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_05_IpSource_CoS_Policy_Rule_QinQ_Untagged_TCP_Packet_with_TCI_Overwrite(self):

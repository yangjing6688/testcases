...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_03_TcpDestPortIP_CoS_Policy_Rule_QinQ_Untagged_IPv6_TCP_Packet_with_TCI_Overwrite(self):

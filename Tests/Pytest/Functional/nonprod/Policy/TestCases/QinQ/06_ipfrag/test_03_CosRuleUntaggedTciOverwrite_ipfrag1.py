...
class CosRuleUntaggedTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_03_IpFrag_CoS_Policy_Rule_QinQ_Untagged_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IP_Frag_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IP_Frag_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.pkt_offset)
         print('  (Verification_3) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IP_Frag_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)

...
class CosRuleUntaggedTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P3
     def test_03_EtherType_CoS_Policy_Rule_QinQ_Untagged_UDP_Packet_with_TCI_Overwrite(self):

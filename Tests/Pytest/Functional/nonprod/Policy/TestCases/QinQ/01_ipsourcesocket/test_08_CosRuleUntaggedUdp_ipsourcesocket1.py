...
class CosRuleUntaggedUdpTests(PolicyBase):
     @mark.EXOS
     @mark.P3
     def test_08_IpSourceSocket_CoS_Policy_Rule_Untagged_UDP_Packet_without_TCI_Overwrite(self):

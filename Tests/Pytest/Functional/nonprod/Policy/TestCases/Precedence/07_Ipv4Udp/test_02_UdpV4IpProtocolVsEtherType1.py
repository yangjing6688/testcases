...
class IpProtocolVsEtherTypeTests(PolicyBase):
     @mark.F_1000043293
     @mark.EXOS
     @mark.P3
     @mark.Precedence
     ...
     @mark.NIGHTLY
     def test_02_IPv4_UDP_Precedence_IP_Protocol_vs_EtherType(self):
         ...
         self.localPolicyUdks.policy_set_rule_ether(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.type_ipv4,forward=True,cos=self.tb.config.cos_5)
         ...
         self.localPolicyUdks.policy_verify_rule_ipproto_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_udp)
         time.sleep(int(self.tb.config.policy_delay))
         ...
         self.localPolicyUdks.policy_verify_rule_ipproto_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_udp,cos=self.tb.config.cos_4)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_2) Verify_100_frames_were_sent_and_NOT_received.')

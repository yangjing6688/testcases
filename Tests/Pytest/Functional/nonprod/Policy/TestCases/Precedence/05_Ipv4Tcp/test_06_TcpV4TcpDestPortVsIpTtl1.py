...
class TcpDestPortVsIpTtlTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_06_IPv4_TCP_Precedence_TCP_Dest_Port_vs_IP_TTL(self):
         ...
         self.localPolicyUdks.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_c)

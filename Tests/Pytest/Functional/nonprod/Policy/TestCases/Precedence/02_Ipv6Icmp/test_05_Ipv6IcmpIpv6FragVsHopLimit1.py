...
class Ipv6FragVsHopLimitTests(PolicyBase):
     @mark.F_1000043246
     @mark.EXOS
     @mark.P2
     @mark.Precedence
     ...
     @mark.NIGHTLY
     def test_05_IPv6_ICMP_Precedence_IPv6_Fragment_vs_Hop_Limit(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_ICMP_Fragments_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,hop_limit=self.tb.config.ttl_a)

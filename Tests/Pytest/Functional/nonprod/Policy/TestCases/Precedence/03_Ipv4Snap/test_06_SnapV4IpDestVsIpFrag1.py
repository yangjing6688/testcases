...
class IpDestVsIpFragTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_06_IPv4_SNAP_Precedence_IP_Destination_vs_IP_Fragment(self):
         ...
         self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_a)
         time.sleep(int(self.tb.config.policy_delay))
         ...
         self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_a,cos=self.tb.config.cos_4)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_2) Verify_100_frames_were_sent_and_NOT_received.')

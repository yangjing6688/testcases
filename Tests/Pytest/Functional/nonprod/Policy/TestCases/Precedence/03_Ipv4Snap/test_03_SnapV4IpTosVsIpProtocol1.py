...
class IpTosVsIpProtocolTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_03_IPv4_SNAP_Precedence_IP_ToS_vs_IP_Protocol(self):
         ...
         self.localPolicyUdks.policy_set_rule_ipproto(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_none,forward=True,cos=self.tb.config.cos_5)
         self.localPolicyUdks.policy_verify_rule_ipproto_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_none,cos=self.tb.config.cos_5)

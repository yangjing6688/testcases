...
class HopLimitVsTrafficClassTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_04_IPv6_UDP_Precedence_Hop_Limit_vs_Traffic_Class(self):
         ...
         self.localPolicyUdks.policy_verify_rule_ipttl_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.ttl_a)
         time.sleep(int(self.tb.config.policy_delay))

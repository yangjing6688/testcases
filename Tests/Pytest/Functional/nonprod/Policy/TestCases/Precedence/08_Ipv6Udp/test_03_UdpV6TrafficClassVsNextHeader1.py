...
class TrafficClassVsNextHeaderTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_03_IPv6_UDP_Precedence_Traffic_Class_vs_Next_Header(self):
         ...
         self.localPolicyUdks.policy_verify_rule_ether_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_udp,cos=self.tb.config.cos_5)

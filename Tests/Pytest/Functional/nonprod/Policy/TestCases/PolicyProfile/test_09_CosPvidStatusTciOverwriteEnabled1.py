...
class CosPvidStatusTciOverwriteEnabledTests(PolicyBase):
     @mark.F_1000043385
     @mark.EXOS
     @mark.P2
     @mark.Policy_Profile
     def test_09_Policy_Profile_CoS_PVID_Status_and_TCI_Overwrite_Enabled(self):
         '''[Documentation]  Test_Objective: Verify_when_TCI_overwrite_is_enabled_and_pvid & cos-status_is_enabled_the_tagged packet_is_associated_to_the_policy_cos & pvid.'''
         ...
         self.localPolicyUdks.Create_Policy_Profile_with_PVID(PVID_Status,COS,COS_Status,and_TCI_Overwrite_Enabled,self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.vlan_b,self.tb.config.cos_5)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_b,self.tb.config.priority_5)
         print('  (Verification_3) Verify_100_tagged_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_b,self.tb.config.priority_5)

...
class Pvid0Tests(PolicyBase):
     @mark.F_1000043379
     @mark.EXOS
     @mark.P3
     @mark.Policy_Profile
     def test_04_Policy_Profile_PVID_0(self):
         '''[Documentation]  Test_Objective: Verify_when_policy_profile_has_a_vlan_set_to_0_all_traffic_is_dropped.'''
         ...
         print('  (Verification_1) Verify_100_untagged_frames_were_sent_and_NOT_received.')
         ...
         print('  (Verification_2) Verify_100_tagged_frames_were_sent_and_NOT_received.')

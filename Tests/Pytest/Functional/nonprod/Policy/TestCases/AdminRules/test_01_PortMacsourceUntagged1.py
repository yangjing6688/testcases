...
class PortMacsourceUngtaggedTests(PolicyBase):
    @mark.F_1000043141
    @mark.EXOS
    @mark.P2
    @mark.Admin_Rules
    ...
    def test_01_Admin_Rules_Per_Port_Macsource_Untagged_Packet(self):
        '''  Test_Objective: Verify_macsource_policy_rules_associate_traffic_correctly_for_unlearnedlearned
        ...
        self.localPolicyUdks.Bounce_Netelem_Port(self.tb.config.netelem1.name,  self.tb.config.netelem1.tgen.port_a.ifname)
        self.localPolicyUdks.Bounce_Netelem_Port(self.tb.config.netelem1.name,  self.tb.config.netelem1.tgen.port_b.ifname)
        ...
        print('  (Verification_3) Verify_100_learned_frames_were_sent_and_received, on_vlan_b.')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(
                  self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_a,  self.tb.config.dst_mac_a,  self.tb.config.vlan_b)

        print('  (Verification_4) Verify_100_learned_frames_were_sent_and_received, on_vlan_a.')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(
                  self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_b,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a)

        print('  (Verification_5) Verify_100_broadcast_frames_were_sent_and_received, on_vlan_b.')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(
        ...
        print('  (Verification_6) Verify_100_broadcast_frames_were_sent_and_received, on_vlan_a.')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(
        ...
        print('  (Verification_8) Verify_100_multicast_frames_were_sent_and_received, on_vlan_a.')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(

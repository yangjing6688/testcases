...
class PortTaggedPvid0Tests(PolicyBase):
    @mark.F_116554
    @mark.EXOS
    @mark.P3
    @mark.Admin_Rules
    ...
    def test_06_Admin_Rules_Per_Port_Macsource_Tagged_Packet_PVID_0(self):
        '''[Documentation]  Test_Objective: Verify_macsource_policy_rules_associate_traffic_correctly_for_unlearned/learned
        ...
        self.localPolicyUdks.Policy_Test_Case_Setup_Admin_Rules_Port()
        ...
        self.tb.config.Transmit_100_Tagged_Frames_and_Verify_NOT_Received(
        ...
        self.tb.config.Transmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(
                  self.tb.config.tgen_ports.netelem1.port_c,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_b,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a,
                 self.tb.config.priority_0)
        ...
        self.tb.config.Transmit_10_Frames_and_Verify_FDB_Entry_is_Learned(self.tb.config.netelem1.name,  self.tb.config.tgen_ports.netelem1.port_a,
        ...
        self.localPolicyUdksTransmit_100_Tagged_Frames_and_Verify_NOT_Received(
                  self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_a,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a)
    
        print('  (Verification_4) Verify_100_learned_frames_were_sent_and_received, with_a_priority_value_of_0.')
        self.localPolicyUdksTransmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(
                  self.tb.config.tgen_ports.netelem1.port_c,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_b,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a,
                 self.tb.config.priority_0)
        ...
        self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(
                  self.tb.config.tgen_ports.netelem1.port_c,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_b,  self.tb.config.bcast_mac,  self.tb.config.vlan_a,
                 self.tb.config.priority_0)
        ...
        self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(
                  self.tb.config.tgen_ports.netelem1.port_c,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_b,  self.tb.config.mcast_mac,  self.tb.config.vlan_a,
                 self.tb.config.priority_0)

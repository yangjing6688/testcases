...
class PartialMatchForwardingTests(PolicyBase): 
    @mark.F_1000_0204
    @mark.EXOS
    @mark.P3
    @mark.Precedence_ACL
    ...
    def test_04_Access_List_Single_Match_Partial_Mask_Forwarding_Tests(self):
        '''[Documentation]  Test_Objective: Verify_An_Access-List_with_partial_masks_Forwards_properly (policy_profile_defaulted_to_drop)'''
        ...
        print('  ======================================================================================================')
        print('_NOTE: COS_will_be_either_3_or_5_depending_on_if_a_cos_value_was_progammed_in_the_access-list "actions')
        print('  ======================================================================================================')
    #
        print('  (Step_4) Assign_icmp_Forward_access_list_rule_to_the_policy_profile. override:(cos_5).)')
        self.localPolicyUdks.change_policy_access_list_profile_index(  self.tb.config.netelem1.name,   self.tb.config.profile_a,    'fwrdp_icmptype')
        ...
        print('  (Verification_4b) Verify_ICMP_100 (type_8_code_5) frames_were_sent_and_received.')
        self.localPolicyUdks.Transmit_100_Untagged_IPv4_ICMP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_a,  self.tb.config.dst_mac_a,  self.tb.config.vlan_b,
              self.tb.config.priority_5,     self.tb.config.src_ip_a,  self.tb.config.dst_ip_a,   None,   None,   None,  None,   '8','5')
    
        print('  (Verification_4c) Verify_ICMP_100_frames (type_3_code_0) were_sent_and_NOT_received.')
        ...
        print('  (Verification_4d) Verify_100_TCP_frames_were_sent_and_NOT_received.')
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_ether')
        ...
        print('  (Verification_5b) Verify_100_ethertype_0x08FF_frames_were_sent_and_received ')
        self.localPolicyUdks.Transmit_100_Untagged_Frames_with_ethertype_and_Verify_Received(
              ...
              self.tb.config.vlan_b,   '0x08FF')
    
        print('  (Verification_5c) Verify_100_ethertype (non_0x0800) frames_were_sent_and_NOT_received.')
    ...
    #       self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   fwrdp_icmp6type
    #
    ...
    #
    #   print('  (Verification_6b) Verify_100_IPV6_ICMP_frames (type_222_code_73) were_sent_and_received
    #        self.localPolicyUdks.Transmit_100_Untagged_IPv6_ICMP_Frames_and_Verify_Priority_Changed
    #          self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    #          self.tb.config.priority_5,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,   icmp_type=222_code=73
    #
    #   print('  (Verification_6c) Verify_100_IPV6_ICMP_frames_type/code_were_sent_and_NOT_received
    ...
    #
    #   print('  (Verification_6d) Verify_100_Non_IPv6_ICMP_frames_were_sent_and_NOT_received.
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_ipDsock')
    
        print('  (Verification_7a) Verify_100_TCP_frames_dst_ip_a:l4_port_c_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_7b) Verify_100_TCP_frames_dst_ip_a:l4_port_b_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_b)
    
        print('  (Verification_7c) Verify_100_TCP_frames_with_dst_ip_b:l4_port_C_were_sent_and_NOT_received.')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    ...
    #       self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   fwrdp_ipfrag
    #
    ...
    #
    #   print('  (Verification_8b) Verify_100_non_fragmented_frames_frames_were_sent_and_NOT_received.
    #          self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received
    #          self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    #          self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_b,
    #
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_ipproto')
        ...
        print('  (Verification_9c) Verify_100_ipproto_TCP (6) frames_were_sent_and_NOT_received.')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_b)
    #
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_ipSsock')
    
        print('  (Verification_10a) Verify_100_ip_Source_Socket (src_ip_a:l4_port_a) frames_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
        ...
        print('  (Verification_10b) Verify_100_ip_Source_Socket (src_ip_a:l4_port_b) frames_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.priority_5,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_c)
    
        print('  (Verification_10c) Verify_100_TCP_Source_Socket (src_ip_b:l4_port_b) frames_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_b,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_c)
    
        print('  (Verification_10d) Verify_100_UDP_Source_Socket (src_ip_b:l4_port_b) frames_were_sent_and_NOT_received')
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_iptos')
        ...
        print('  (Verification_11b) Verify_100_frames_iptos_of_28_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c,  tos='31')
    
        print('  (Verification_11c) Verify_100_frames_iptos_of_15_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_ipttl')
        ...
        print('  (Verification_12b) Verify_100_frames_ipttl_of_8_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c,  ttl='10')
    
        print('  (Verification_12c) Verify_100_frames_ipttl_of_5_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_tcpDportIP')
        ...
        print('  (Verification_13b) Verify_100_TCP_frames_dest:(l4_port_c:dst_ip_b) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_b,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_13c) Verify_100_UDP_frames_dest:(l4_port_c:dst_ip_a) no_match (UDP_not_TCP) were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_13d) Verify_100_TCP_Frames_dest:(l4_port_a:dst_ip_a) no_match_frames_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
        ...
        print('  (Verification_13e) Verify_100_UDP_frames_dest:(l4_port_b:src_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_tcpSportIP')
        ...
        print('  (Verification_14b) Verify_100_TCP_frames_src:(l4_port_a:dst_ip_b) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.priority_5,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_b,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_14c) Verify_100_UDP_frames_src:(l4_port_c:dst_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,     self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_14d) Verify_100_TCP_Frames_src:(l4_port_a:dst_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('  (Verification_14e) Verify_100_UDP_frames_src:(l4_port_b:src_ip_a) nomatch_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_b)
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_udpDportIP')
        ...
        print('  (Verification_15b) Verify_100_UDP_frames_dest:(l4_port_c:dst_ip_b) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.priority_5,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_b,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_15c) Verify_100_TCP_frames_dest:(l4_port_c:dst_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_15d) Verify_100_UDP_Frames_dest:(l4_port_a:dst_ip_a) no_match_frames_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('  (Verification_15e) Verify_100_TCP_frames_dest:(l4_port_a:src_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    #
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'fwrdp_udpSportIP')
        ...
        print('  (Verification_16b) Verify_100_UDP_frames_dest:(l4_port_a:src_ip_b) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_b,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_16c) Verify_100_TCP_frames_dest:(l4_port_a:src_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_16d) Verify_100_UDP_Frames_dest:(l4_port_b:src_ip_a) no_match_frames_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('  (Verification_16e) Verify_100_TCP_frames_dest:(l4_port_b:src_ip_a) no_match_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_b,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)

...
class DropRuleUntaggedTcpTests(PolicyBase):
     ...
     def test_07_TcpSourcePortIP_Policy_Drop_Rule_Untagged_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_tcpsourceportip_policy_drop_rule_discards_untagged_packets.'''

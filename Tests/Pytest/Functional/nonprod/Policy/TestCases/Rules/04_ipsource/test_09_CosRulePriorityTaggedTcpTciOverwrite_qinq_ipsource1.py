...
class CosRulePriorityTaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_09_IpSource_CoS_Policy_Rule_Priority_Tagged_TCP_Packet_with_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_ipsource_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_enabled.'''

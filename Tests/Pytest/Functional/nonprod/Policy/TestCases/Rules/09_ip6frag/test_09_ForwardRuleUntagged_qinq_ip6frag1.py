...
class ForwardRuleUntaggedTests(PolicyBase):
     ...
     def test_09_Ip6Frag_Policy_Forward_Rule_with_PVID_Override_0_Untagged_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ip6frag_policy_forward_rule_forwards_untagged_TCP_packets.'''
         ...
         self.localPolicyUdks.policy_set_rule_ipfrag(self.tb.config.netelem1.name,self.tb.config.profile_a,forward=True)
         self.localPolicyUdks.policy_verify_rule_ipfrag_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,forward=True)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)

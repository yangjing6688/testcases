...
class CosRuleUntaggedUdpTciOverwriteTests(PolicyBase):
     ...
     def test_03_UdpDestPortIP_CoS_Policy_Rule_Untagged_IPv6_UDP_Packet_with_TCI_Overwrite(self):

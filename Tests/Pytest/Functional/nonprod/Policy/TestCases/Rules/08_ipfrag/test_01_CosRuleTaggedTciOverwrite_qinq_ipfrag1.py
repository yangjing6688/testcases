...
class CosRuleTaggedTciOverwriteTests(PolicyBase):
     ...
     def test_01_IpFrag_CoS_Policy_Rule_Tagged_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)
         print('  (Verification_10) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)

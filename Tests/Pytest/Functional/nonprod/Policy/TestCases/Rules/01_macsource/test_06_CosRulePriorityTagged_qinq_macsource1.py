...
class CosRulePriorityTaggedTests(PolicyBase):
     ...
     @mark.P1
     @mark.Policy_Rules
     @mark.Policy_MacSrc_Rules
     def test_06_Macsource_CoS_Policy_Rule_Priority_Tagged_Packet_without_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.policy_set_rule_macsource(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,cos=self.tb.config.cos_5)
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,cos=self.tb.config.cos_5)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_Frames_and_Verify_Priority_has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2)

...
class ForwardRuleUntaggedTests(PolicyBase):
     ...
     def test_09_MacSource_Policy_Forward_Rule_with_PVID_Override_0_Untagged_Packet(self):
         ...
         self.localPolicyUdks.policy_set_rule_macsource(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,forward=True)
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,forward=True)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a)

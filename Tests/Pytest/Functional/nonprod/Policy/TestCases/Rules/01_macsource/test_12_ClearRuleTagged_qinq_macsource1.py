...
class ClearRuleTaggedTests(PolicyBase):
     ...
     def test_12_MacSource_Policy_Clear_Drop_Rule_Tagged_Packet(self):
         ...
         self.localPolicyUdks.policy_set_rule_macsource(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,drop=True)
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,drop=True)
         ...
         self.localPolicyUdks.Remove_Policy_Rule_MacSource(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a)
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,drop=True)
         time.sleep(int(self.tb.config.policy_delay))

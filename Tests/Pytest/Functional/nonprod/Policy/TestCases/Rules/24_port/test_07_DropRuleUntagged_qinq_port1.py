...
class DropRuleUntaggedTests(PolicyBase):
     @mark.F_1000043138
     @mark.EXOS
     @mark.P3
     @mark.Policy_Rules
     @mark.Policy_Port_Rules
     def test_07_Port_Policy_Drop_Rule_Untagged_Packet(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_c,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_c,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_c,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a)

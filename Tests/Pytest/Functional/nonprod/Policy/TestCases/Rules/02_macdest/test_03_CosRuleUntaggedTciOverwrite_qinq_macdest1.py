...
class CosRuleUntaggedTciOverwriteTests(PolicyBase):
     ...
     def test_03_MacDest_CoS_Policy_Rule_Untagged_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_b,self.tb.config.vlan_a,self.tb.config.priority_3)

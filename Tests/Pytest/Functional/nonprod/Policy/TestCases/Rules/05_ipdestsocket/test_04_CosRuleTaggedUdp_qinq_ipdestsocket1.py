...
class CosRuleTaggedUdpTests(PolicyBase):
     ...
     def test_04_IpDestSocket_CoS_Policy_Rule_Tagged_UDP_Packet_without_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_ipdestsocket_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_disabled.'''

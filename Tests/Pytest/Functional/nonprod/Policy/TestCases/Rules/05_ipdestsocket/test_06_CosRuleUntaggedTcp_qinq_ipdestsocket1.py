...
class CosRuleUntaggedTcpTests(PolicyBase):
     ...
     def test_06_IpDestSocket_CoS_Policy_Rule_Untagged_TCP_Packet_without_TCI_Overwrite(self):
         ...
         print('  (Verification_9) Verify_100_learned_frames_were_sent_and_received, with_a_priority_value_of_3.')

...
class CosRuleTaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_01_TcpDestPortIP_CoS_Policy_Rule_Tagged_TCP_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.l4_port_a,self.tb.config.l4_port_c,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_b)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         print('  (Verification_4) Verify_100_learned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.l4_port_a,self.tb.config.l4_port_b)
         print('  (Verification_5) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         print('  (Verification_6) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.l4_port_a,self.tb.config.l4_port_b)
         print('  (Verification_7) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_5,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         print('  (Verification_8) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.l4_port_a,self.tb.config.l4_port_b)

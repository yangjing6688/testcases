...
class DropRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_07_UdpSourcePortIP_Policy_Drop_Rule_Untagged_IPv6_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_udpsourceportip_policy_drop_rule_discards_untagged_IPv6_packets.'''

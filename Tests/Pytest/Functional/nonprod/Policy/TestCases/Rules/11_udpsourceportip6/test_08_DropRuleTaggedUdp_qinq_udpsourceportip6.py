...
class DropRuleTaggedUdpTests(PolicyBase):
     ...
     def test_08_UdpSourcePortIP_Policy_Drop_Rule_Tagged_IPv6_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_udpsourceportip_policy_drop_rule_discards_tagged_IPv6_packets.'''

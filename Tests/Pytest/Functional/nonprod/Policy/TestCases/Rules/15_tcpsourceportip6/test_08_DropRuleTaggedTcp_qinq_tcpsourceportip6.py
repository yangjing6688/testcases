...
class DropRuleTaggedTcpTests(PolicyBase):
     ...
     def test_08_TcpSourcePortIP_Policy_Drop_Rule_Tagged_IPv6_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_tcpsourceportip_policy_drop_rule_discards_tagged_IPv6_packets.'''

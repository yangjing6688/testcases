...
class ForwardRuleTaggedTests(PolicyBase):
     ...
     def test_10_IpProto_Policy_Forward_Rule_with_PVID_Override_0_Tagged_Packet(self):
         ...
         self.localPolicyUdks.policy_set_rule_ipproto(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_tcp,forward=True)
         self.localPolicyUdks.policy_verify_rule_ipproto_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.proto_tcp,forward=True)

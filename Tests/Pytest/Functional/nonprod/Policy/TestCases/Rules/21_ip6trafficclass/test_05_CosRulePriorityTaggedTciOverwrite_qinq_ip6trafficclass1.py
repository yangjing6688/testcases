...
class CosRulePriorityTaggedTciOverwriteTests(PolicyBase):
     ...
     def test_05_Ip6TrafficClass_CoS_Policy_Rule_Priority_Tagged_Packet_with_TCI_Overwrite(self):

...
class CosRulePriorityTaggedTests(PolicyBase):
     ...
     @mark.P3
     @mark.Policy_Rules
     @mark.Policy_IpV6HopLimit_Rules
     def test_06_IpTTL_CoS_Policy_Rule_Priority_Tagged_Packet_without_TCI_Overwrite(self):

...
class ClearRuleUntaggedTcpTests(PolicyBase):
     ...
     def test_21_Ip6Dest_Policy_Clear_Drop_Rule_Untagged_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_traffic_passes_again_after_removing_an_ip6dest_policy_drop_rule.'''
         ...
         self.localPolicyUdks.policy_set_rule_ip6dest(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_b,drop=True)
         ...
         self.localPolicyUdks.policy_verify_rule_ip6dest_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_b,drop=True)
         ...
         self.localPolicyUdks.Remove_Policy_Rule_Ip6Dest(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_a)
         self.localPolicyUdks.Remove_Policy_Rule_Ip6Dest(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_b)
         self.localPolicyUdks.policy_verify_rule_ip6dest_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_a,drop=True)
         self.localPolicyUdks.policy_verify_rule_ip6dest_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_b,drop=True)
         time.sleep(int(self.tb.config.policy_delay))

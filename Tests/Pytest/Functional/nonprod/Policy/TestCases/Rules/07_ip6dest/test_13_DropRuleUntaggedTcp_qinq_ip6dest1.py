...
class DropRuleUntaggedTcpTests(PolicyBase):
     ...
     def test_13_Ip6Dest_Policy_Drop_Rule_Untagged_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ip6dest_policy_drop_rule_discards_untagged_packets.'''
         ...
         self.localPolicyUdks.policy_verify_rule_ip6dest_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip6_a,drop=True)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_TCP_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_TCP_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_TCP_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)

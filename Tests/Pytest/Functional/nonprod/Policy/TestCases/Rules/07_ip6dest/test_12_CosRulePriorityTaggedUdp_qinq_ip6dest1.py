...
class CosRulePriorityTaggedUdpTests(PolicyBase):
     ...
     @mark.P2
     @mark.Policy_Rules
     @mark.Policy_IpV6Dst_Rules
     def test_12_Ip6Dest_CoS_Policy_Rule_Priority_Tagged_UDP_Packet_without_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_ip6dest_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_disabled.'''
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IPv6_UDP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IPv6_UDP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IPv6_UDP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)

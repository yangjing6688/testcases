...
class ForwardRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_18_Ip6Dest_Policy_Forward_Rule_with_PVID_Override_0_Untagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ip6dest_policy_forward_rule_forwards_untagged_UDP_packets.'''

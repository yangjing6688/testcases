...
class CosRuleTaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_01_Ip6Dest_CoS_Policy_Rule_Tagged_TCP_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.priority_3,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)

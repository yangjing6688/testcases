...
class ForwardRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_18_IpSourceSocket_Policy_Forward_Rule_with_PVID_Override_0_Untagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ipsourcesocket_policy_forward_rule_forwards_untagged_UDP_packets.'''
         ...
         self.localPolicyUdks.policy_set_rule_ipsourcesocket(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,self.tb.config.l4_port_b,forward=True)
         ...
         self.localPolicyUdks.policy_verify_rule_ipsourcesocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,self.tb.config.l4_port_b,forward=True)

...
class CosRulePriorityTaggedUdpTests(PolicyBase):
     ...
     def test_12_IpSourceSocket_CoS_Policy_Rule_Priority_Tagged_UDP_Packet_without_TCI_Overwrite(self):

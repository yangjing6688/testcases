...
class TcpDestPortIpTests(PolicyBase):
    @mark.F_1000043226
    @mark.EXOS
    @mark.P3
    @mark.Policy_Masking
    ...
    def test_07_Masking_Precedence_TCPDestPortIP(self):
        '''[Documentation]  Test_Objective: Verify_tcpdestportip_policy_rules_drop_or_forward_traffic_correctly_when_using
                      masks.'''
        ...
        self.localPolicyUdks.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,    self.tb.config.mask_l4ip_f,  mask='8',
                                                        drop='True')
        ...
        self.localPolicyUdks.policy_set_rule_tcpdestportip(        self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='16',
                                                     forward='True')
        ...
        self.localPolicyUdks.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='24',
                                                     drop='True')
        self.localPolicyUdks.policy_verify_rule_tcpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_c,  mask='24')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_tcpdestportip(        self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='32',
                                                     forward='True')
        self.localPolicyUdks.policy_verify_rule_tcpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_d,  mask='32')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='40',
                                                     drop='True')
        self.localPolicyUdks.policy_verify_rule_tcpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_e,  mask='40')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='48',
                                                     forward='True')
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_tcpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask='48')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.

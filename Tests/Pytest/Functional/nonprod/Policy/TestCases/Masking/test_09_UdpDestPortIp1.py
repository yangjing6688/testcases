...
class UdpDestPortIpTests(PolicyBase):
    @mark.F_1000043224
    @mark.EXOS
    @mark.P2
    @mark.Policy_Masking
    ...
    def test_09_Masking_Precedence_UDPDestPortIP(self):
        '''[Documentation]  Test_Objective: Verify_udpdestportip_policy_rules_drop_or_forward_traffic_correctly_when_using
                      masks.'''    
        ...
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,self.tb.config.mask_l4ip_f,  mask=8,
                                                        drop=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(self.tb.config.netelem1.name,  self.tb.config.profile_a,    self.tb.config.mask_l4ip_a,  mask=8,
                                                        drop=True)
        ...
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
                  ...
                  self.tb.config.src_ip_b,       self.tb.config.src_ip_a,  self.tb.config.l4_port_b,     self.tb.config.l4_port_a)
    
        print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_NOT_received.')
        self.localPolicyUdks.Transmit_100_Tagged_UDP_Frames_and_Verify_NOT_Received(
                  self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_a,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a,
                  self.tb.config.src_ip_b,       self.tb.config.src_ip_a,  self.tb.config.l4_port_b,     self.tb.config.l4_port_a)
    
        print('  (Step_3) Create_additional_Policy_Rules.')
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=16,
                                                     forward=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_b,  mask=16,
                                                     forward=True)
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.Transmit_100_Tagged_UDP_Frames_and_Verify_Received(
                  self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,  self.tb.config.src_mac_a,  self.tb.config.dst_mac_a,  self.tb.config.vlan_a,
                  self.tb.config.src_ip_b,       self.tb.config.src_ip_a,  self.tb.config.l4_port_b,     self.tb.config.l4_port_a)
    
        print('  (Step_4) Create_additional_Policy_Rules.')
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=24,
                                                     drop=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_c,  mask=24,
                                                     drop=True)
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=32,
                                                     forward=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_d,  mask=32,
                                                     forward=True)
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=40,
                                                     drop=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_e,  mask=40,
                                                     drop=True)
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_udpdestportip(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=48,
                                                     forward=True)
        self.localPolicyUdks.networkElementPolicyGenKeywords.policy_verify_rule_udpdestportip_exists(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_l4ip_f,  mask=48,
                                                     forward=True)
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.

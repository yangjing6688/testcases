...
class IpDestSocketTests(PolicyBase):
    @mark.F_1000043222
    @mark.EXOS
    @mark.P2
    @mark.Policy_Masking
    ...
    def test_04_Masking_Precedence_IPDestSocket(self):
        '''[Documentation]  Test_Objective: Verify_ipdestsocket_policy_rules_drop_or_forward_traffic_correctly_when_using
                      masks.'''
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a, self.tb.config.src_ip_a,  mask='8',
                                                        drop=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,  self.tb.config.profile_a, self.tb.config.mask_ip_a,  mask='8')
        ...
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
                  ...
                  self.tb.config.src_ip_b,       self.tb.config.src_ip_a,  self.tb.config.l4_port_a,     self.tb.config.l4_port_b)
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a, self.tb.config.src_ip_a, mask='16',forward=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a, self.tb.config.mask_ip_b,  mask='16')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,   mask='24',drop=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.mask_ip_c,  mask='24')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  mask='32',forward=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  mask='32')
        time.sleep(int(self.tb.config.policy_delay)) # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  self.tb.config.l4_port_b,  mask='40',
                                                      drop=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(  self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  self.tb.config.mask_l4port_a,
                                                      mask='40')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.
        ...
        self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  self.tb.config.l4_port_b,  mask='48',
                                                      forward=True)
        self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,  self.tb.config.profile_a,  self.tb.config.src_ip_a,  self.tb.config.l4_port_b,  mask='48')
        time.sleep(int(self.tb.config.policy_delay))  # Delay_for_EXOS_policy_hardware_config_batching.

...
csv_file_location = "/automation/tests/extreme_automation_tests/TestBeds/SALEM/SystemTest/1_node/slm_5420.csv"
csv_file_location2 = "/automation/tests/extreme_automation_tests/TestBeds/SALEM/SystemTest/1_node/slm_5420_location.csv"
needToDeleteDevice = False



@mark.testbed_1_node
class onboardDevice5420UsingCsvTests():
    ...
    def test_onboard_device_using_csv_without_location(self,test_case_skip_check,test_case_started_ended_print):
        '''[Documentation]  Test_Objective: Verify a 5420 device can be onboared using a csv file'''
    ...
    def test_onboard_device_using_csv_with_location(self,test_case_skip_check,test_case_started_ended_print):
        '''[Documentation]  Test_Objective: Verify a 5420 device can be onboared using a csv file and selecting the location field'''
        global needToDeleteDevice

...
class TCXM22599Tests(XIQBase):
    @pytest.mark.development
    @pytest.mark.xim_tcxm_22599
    @pytest.mark.p1
    def test_tcxm_22599(self, onboard_location):
        """
        ...
        self.cfg['${TEST_NAME}'] = 'test_tcxm_22599_run'
        dut = self.tb.dut1
        ...
        try:
            ...
            self.cfg['${TEST_NAME}'] = 'test_tcxm_22599_teardown'

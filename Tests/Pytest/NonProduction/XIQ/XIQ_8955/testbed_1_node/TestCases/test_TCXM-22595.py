...
class TCXM22595Tests(XIQBase):
    @pytest.mark.development
    @pytest.mark.xim_tcxm_22594
    @pytest.mark.xim_tcxm_22595
    @pytest.mark.p1
    def test_tcxm_22595(self, onboard_location):
        """
        ...
        self.cfg['${TEST_NAME}'] = 'test_tcxm_22595_run'
        dut = self.tb.dut1
        ...
        try:
            ...
            self.cfg['${TEST_NAME}'] = 'test_tcxm_22595_teardown'

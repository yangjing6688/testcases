...
class TCXM22593Tests(XIQBase):
    @pytest.mark.development
    @pytest.mark.xim_tcxm_22593
    @pytest.mark.p1
    def test_tcxm_22593(self, onboard_location):
        """
        ...
        self.cfg['${TEST_NAME}'] = 'test_tcxm_22593_run'
        dut = self.tb.dut1
        ...
        try:
            ...
            assert self.localSuiteUdks.check_text_enable_auto_revert_option() == 1, \
            ...
            self.cfg['${TEST_NAME}'] = 'test_tcxm_22593_teardown'

# Author:         vstefan
# Description:    Verify that value 1 can be set for Path Cost for the 7th port on each ASIC.
# Story:          XIQ 1557 Missing path cost in Template configs for STP
# Testcases:      TCXM-22141
...
class TCXM22141Tests(xiqBase):

    @pytest.mark.xim_tcxm_22141
    @pytest.mark.development
    @pytest.mark.EXOS
    @pytest.mark.VOSS
    @pytest.mark.p2
    @pytest.mark.testbed_1_node
    def test_22141_verify_value_1_as_path_cost(self, onboarded_switch, network_policy, template_switch):
        """
        ...
        self.cfg['${TEST_NAME}'] = 'test_XIQ_1557_TCXM_22141'

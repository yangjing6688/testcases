# Author:         vstefan
# Description:    Verify that value 200000000 can be set for Path Cost for the second port on each ASIC.
# Story:          XIQ 1557 Missing path cost in Template configs for STP
# Testcases:      TCXM-22142
...
class TCXM22142Tests(xiqBase):

    @pytest.mark.xim_tcxm_22142
    @pytest.mark.development
    @pytest.mark.EXOS
    @pytest.mark.VOSS
    @pytest.mark.p2
    @pytest.mark.testbed_1_node
    def test_22142_verify_value_200000000_as_path_cost(self, onboarded_switch, network_policy, template_switch):
        """
        ...
        4	        Go to Network Policy -> Switch Template -> Port Configuration and  click Create Port Type for
        ...
        7	        Set value 200000000 for Path Cost and save the configuration.
        8	        Go to Network Policy -> Switch Template -> Port Configuration -> STP tab and verify that the value
                    for the modified Path Cost is 200000000.
        ...
        self.cfg['${TEST_NAME}'] = 'test_XIQ_1557_TCXM_22142'

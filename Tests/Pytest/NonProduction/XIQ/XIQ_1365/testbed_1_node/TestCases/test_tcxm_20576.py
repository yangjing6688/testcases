...
class TCXM20576Tests(xiqBase):

    @pytest.mark.development
    @pytest.mark.xim_tcxm_20576
    @pytest.mark.p1
    def test_tcxm_20576(self,onboarding_location):
        """
        Author        :     tpodar
        Description   :     Verify that Toggle for "Upgrade device firmware upon device authentication" is present.
        Prerequisites:      None
        ...
        4.                  Upgrade device firmware upon device authentication should be off by default
        """
        self.executionHelper.testSkipCheck()

        self.cfg['${test_name}'] = 'test1_tcxm_20576'
        dut = self.tb.dut1
        ...
        try:
            ...
            self.localsuiteudks.add_sw_template_adv_settings_tab_tcxm_20576(network_policy_name, sw_name_final, device_template_name)

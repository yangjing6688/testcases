...
class Ipv6DestVsIpv6FragTests(PolicyBase):
     @mark.F_1000043247
     @mark.EXOS
     @mark.P2
     @mark.Precedence
     ...
     @mark.NIGHTLY
     def test_06_IPv6_ICMP_Precedence_IPv6_Destination_vs_IPv6_Fragment(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_ICMP_Fragments_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a)

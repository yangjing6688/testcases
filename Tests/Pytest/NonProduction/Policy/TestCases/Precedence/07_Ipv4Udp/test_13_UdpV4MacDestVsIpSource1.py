...
class MacDestVsIpSourceTests(PolicyBase):
     @mark.F_126899
     @mark.EXOS
     @mark.P3
     @mark.Precedence
     ...
     @mark.NIGHTLY
     def test_13_IPv4_UDP_Precedence_MAC_Dest_vs_IP_Source(self):
         ...
         self.localPolicyUdks.policy_set_rule_ipsourcesocket(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,forward=True,cos=self.tb.config.cos_5)

...
class TcpDestPortVsHopLimitTests(PolicyBase):
     @mark.F_1000043286
     @mark.EXOS
     @mark.P3
     @mark.Precedence
     ...
     @mark.NIGHTLY
     def test_05_IPv6_TCP_Precedence_TCP_Dest_Port_vs_Hop_Limit(self):
         ...
         self.localPolicyUdks.policy_verify_rule_tcpdestportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_c)
         time.sleep(int(self.tb.config.policy_delay))
         ...
         self.localPolicyUdks.policy_set_rule_tcpdestportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_c,forward=True,cos=self.tb.config.cos_4)
         self.localPolicyUdks.policy_verify_rule_tcpdestportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_c,cos=self.tb.config.cos_4)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_2) Verify_100_frames_were_sent_and_NOT_received.')

...
class EtherTypeVsPortTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_01_IPv6_TCP_Precedence_EtherType_vs_Port(self):
         ...
         self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_ether(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.type_ipv6,drop=True)
         ...
         self.localPolicyUdks.networkElementPolicyGenKeywords.policy_set_rule_ether(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.type_ipv6,forward=True,cos=self.tb.config.cos_4)

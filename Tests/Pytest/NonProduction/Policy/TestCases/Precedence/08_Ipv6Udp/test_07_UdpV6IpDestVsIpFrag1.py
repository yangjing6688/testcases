...
class IpDestVsIpFragTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_07_IPv6_UDP_Precedence_IPv6_Destination_vs_IPv6_Fragment(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IPv6_UDP_Fragments_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_a,dst_port=self.tb.config.l4_port_c)

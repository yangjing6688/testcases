...
class MacSourceVsMacDestTests(PolicyBase):
     ...
     @mark.NIGHTLY
     def test_09_IPv6_UDP_Precedence_MAC_Source_vs_MAC_Dest(self):
         ...
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a)
         time.sleep(int(self.tb.config.policy_delay))
         ...
         self.localPolicyUdks.policy_verify_rule_macsource_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_mac_a,cos=self.tb.config.cos_4)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_2) Verify_100_frames_were_sent_and_NOT_received.')

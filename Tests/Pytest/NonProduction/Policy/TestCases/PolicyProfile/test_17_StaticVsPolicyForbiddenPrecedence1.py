...
class StaticVsPolicyForbiddenPrecedenceTests(PolicyBase):
     @mark.F_127926
     @mark.EXOS
     @mark.P3
     @mark.Policy_Profile
     def test_17_Policy_Profile_Static_vs_Policy_Forbidden_VLAN_Precedence(self):
         '''[Documentation]  Test_Objective: Verify_static_vlan_egress_settings_have_precedence_over_a_policy_profile configured_with_forbidden-vlans.'''

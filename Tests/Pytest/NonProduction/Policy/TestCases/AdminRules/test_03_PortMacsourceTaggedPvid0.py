...
class PortMacsourceTaggedPvid0Tests(PolicyBase):
    @mark.F_116552
    @mark.EXOS
    @mark.P3
    @mark.Admin_Rules
    @mark.BUILD_NIGHTLY
    def test_03_Admin_Rules_Per_Port_Macsource_Tagged_Packet_PVID_0(self):

...
class CosRuleTaggedUdpTciOverwriteTests(PolicyBase):
     ...
     def test_01_UdpSourcePortIP_CoS_Policy_Rule_Tagged_IPv6_UDP_Packet_with_TCI_Overwrite(self):

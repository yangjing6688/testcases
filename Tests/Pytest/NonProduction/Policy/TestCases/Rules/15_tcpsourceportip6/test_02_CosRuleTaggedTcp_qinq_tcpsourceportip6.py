...
class CosRuleTaggedTcpTests(PolicyBase):
     ...
     def test_02_TcpSourcePortIP_CoS_Policy_Rule_Tagged_IPv6_TCP_Packet_without_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_tcpsourceportip_policy_rules_associate_IPv6_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_disabled.'''
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_b,dst_port=self.tb.config.l4_port_c)
         ...
         print('  (Verification_6) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_b,dst_port=self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_TCP_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,src_port=self.tb.config.l4_port_b,dst_port=self.tb.config.l4_port_c)

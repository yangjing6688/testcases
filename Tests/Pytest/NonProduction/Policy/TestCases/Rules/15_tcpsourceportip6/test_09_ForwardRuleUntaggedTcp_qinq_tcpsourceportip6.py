...
class ForwardRuleUntaggedTcpTests(PolicyBase):
     ...
     def test_09_TcpSourcePortIP_Policy_Forward_Rule_with_PVID_Override_0_Untagged_IPv6_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_tcpsourceportip_policy_forward_rule_forwards_untagged_IPv6_TCP_packets.'''

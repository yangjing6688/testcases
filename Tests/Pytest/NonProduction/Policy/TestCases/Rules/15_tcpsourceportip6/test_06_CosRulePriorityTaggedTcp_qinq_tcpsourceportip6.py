...
class CosRulePriorityTaggedTcpTests(PolicyBase):
     ...
     def test_06_TcpSourcePortIP_CoS_Policy_Rule_Priority_Tagged_IPv6_TCP_Packet_without_TCI_Overwrite(self):

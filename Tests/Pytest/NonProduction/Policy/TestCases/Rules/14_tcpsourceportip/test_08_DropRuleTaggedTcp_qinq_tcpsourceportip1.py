...
class DropRuleTaggedTcpTests(PolicyBase):
     ...
     def test_08_TcpSourcePortIP_Policy_Drop_Rule_Tagged_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_tcpsourceportip_policy_drop_rule_discards_tagged_packets.'''
         ...
         self.localPolicyUdks.policy_set_rule_tcpsourceportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_a,drop=True)
         self.localPolicyUdks.policy_set_rule_tcpsourceportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_ip,drop=True)
         self.localPolicyUdks.policy_verify_rule_tcpsourceportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_a,drop=True)
         self.localPolicyUdks.policy_verify_rule_tcpsourceportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_ip,drop=True)

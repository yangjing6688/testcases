...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_03_TcpSourcePortIP_CoS_Policy_Rule_Untagged_TCP_Packet_with_TCI_Overwrite(self):

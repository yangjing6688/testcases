...
class DropRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_07_UdpSourcePortIP_Policy_Drop_Rule_Untagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_udpsourceportip_policy_drop_rule_discards_untagged_packets.'''
         ...
         self.localPolicyUdks.policy_set_rule_udpsourceportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_a,drop=True)
         self.localPolicyUdks.policy_set_rule_udpsourceportip(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_ip,drop=True)
         self.localPolicyUdks.policy_verify_rule_udpsourceportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_a,drop=True)
         self.localPolicyUdks.policy_verify_rule_udpsourceportip_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.l4_port_ip,drop=True)

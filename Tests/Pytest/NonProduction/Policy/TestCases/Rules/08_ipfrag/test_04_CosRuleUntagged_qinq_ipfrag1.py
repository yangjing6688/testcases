...
class CosRuleUntaggedTests(PolicyBase):
     ...
     def test_04_IpFrag_CoS_Policy_Rule_Untagged_Packet_without_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.pkt_offset)
         print('  (Verification_3) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         print('  (Verification_5) Verify_100_learned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.pkt_offset)
         print('  (Verification_6) Verify_100_learned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)
         print('  (Verification_7) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         print('  (Verification_8) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.pkt_offset)
         print('  (Verification_9) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)
         print('  (Verification_10) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         print('  (Verification_11) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.pkt_offset)
         print('  (Verification_12) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_3,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.no_flag,self.tb.config.no_offset)

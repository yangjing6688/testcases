...
class DropRuleTaggedTests(PolicyBase):
     ...
     def test_08_IpFrag_Policy_Drop_Rule_Tagged_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ipfrag_policy_drop_rule_discards_tagged_packets.'''
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)
         ...
         self.localPolicyUdks.Transmit_100_Untagged_IP_Frag_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.pkt_id,self.tb.config.mf_flag,self.tb.config.no_offset)

...
class ClearRuleUntaggedTests(PolicyBase):
     ...
     def test_11_IpFrag_Policy_Clear_Drop_Rule_Untagged_Packet(self):
         '''[Documentation]  Test_Objective: Verify_traffic_passes_again_after_removing_an_ipfrag_policy_drop_rule.'''

...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_03_TcpDestPortIP_CoS_Policy_Rule_Untagged_TCP_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_4,self.tb.config.src_ip_a,self.tb.config.src_ip_b,self.tb.config.l4_port_a,self.tb.config.l4_port_b)

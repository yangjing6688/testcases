...
class ClearRuleTaggedTests(PolicyBase):
     @mark.EXOS
     @mark.P3
     @mark.Policy_Rules
     @mark.Policy_Port_Rules
     def test_12_Port_Policy_Clear_Drop_Rule_Tagged_Packet(self):
         '''[Documentation]  Test_Objective: Verify_traffic_passes_again_after_removing_a_macsource_policy_drop_rule.'''
         print('  (Step_1) Configure_ports, QoS, and_FDB_for_Policy_traffic_tests.')
         self.localPolicyUdks.Policy_Test_Case_Setup_D()
         ...
         self.localPolicyUdks.policy_set_rule_port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_1) Verify_100_unlearned_frames_were_sent_and_NOT_received.')
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         print('  (Verification_2) Clear_drop_rule_and_Verify_100_unlearned_frames_were_sent_and_received.')
         self.localPolicyUdks.Remove_Policy_Rule_Port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         print('  (Step_3) Bounce_traffic_ports_to_clear_FDB_entries, re-create_policy_drop_rule, and_prime_FDB_with_traffic.')
         ...
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         print('  (Verification_4) Clear_drop_rule_and_Verify_100_unlearned_frames_were_sent_and_received.')
         self.localPolicyUdks.Remove_Policy_Rule_Port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a)
         print('  (Step_4) Re-create_policy_drop_rule.')
         self.localPolicyUdks.policy_set_rule_port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_5) Verify_100_unlearned_frames_were_sent_and_NOT_received.')
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a)
         print('  (Verification_6) Clear_drop_rule_and_Verify_100_unlearned_frames_were_sent_and_received.')
         self.localPolicyUdks.Remove_Policy_Rule_Port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a)
         print('  (Step_5) Re-create_policy_drop_rule.')
         self.localPolicyUdks.policy_set_rule_port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         print('  (Verification_7) Verify_100_unlearned_frames_were_sent_and_NOT_received.')
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_NOT_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a)
         print('  (Verification_8) Clear_drop_rule_and_Verify_100_unlearned_frames_were_sent_and_received.')
         self.localPolicyUdks.Remove_Policy_Rule_Port(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname)
         self.localPolicyUdks.policy_verify_rule_port_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.netelem1.tgen.port_a.ifname,drop=True)
         time.sleep(int(self.tb.config.policy_delay))
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a)

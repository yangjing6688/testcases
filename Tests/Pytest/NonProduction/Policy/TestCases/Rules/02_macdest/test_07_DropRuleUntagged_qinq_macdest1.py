...
class DropRuleUntaggedTests(PolicyBase):
     ...
     def test_07_MacDest_Policy_Drop_Rule_Untagged_Packet(self):
         ...
         self.localPolicyUdks.Transmit_100_Untagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_b,self.tb.config.vlan_a)

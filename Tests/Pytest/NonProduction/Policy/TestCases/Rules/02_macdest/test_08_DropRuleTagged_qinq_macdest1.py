...
class DropRuleTaggedTests(PolicyBase):
     ...
     def test_08_MacDest_Policy_Drop_Rule_Tagged_Packet(self):
         '''[Documentation]  Test_Objective: Verify_macdest_policy_drop_rule_discards_tagged_packets.'''
         ...
         self.localPolicyUdks.Transmit_100_Tagged_Frames_and_Verify_Received(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_b,self.tb.config.vlan_a)

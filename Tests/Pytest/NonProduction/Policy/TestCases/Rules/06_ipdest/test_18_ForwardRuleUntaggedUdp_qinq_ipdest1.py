...
class ForwardRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_18_IpDest_Policy_Forward_Rule_with_PVID_Override_0_Untagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ipdest_policy_forward_rule_forwards_untagged_UDP_packets.'''
         ...
         self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_a,forward=True)
         self.localPolicyUdks.policy_set_rule_ipdestsocket(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_b,forward=True)
         self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_a,forward=True)
         self.localPolicyUdks.policy_verify_rule_ipdestsocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.dst_ip_b,forward=True)

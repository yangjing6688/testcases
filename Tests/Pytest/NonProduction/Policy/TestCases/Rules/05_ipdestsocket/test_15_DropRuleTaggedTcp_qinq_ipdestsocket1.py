...
class DropRuleTaggedTcpTests(PolicyBase):
     ...
     def test_15_IpDestSocket_Policy_Drop_Rule_Tagged_TCP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ipdestsocket_policy_drop_rule_discards_tagged_packets.'''

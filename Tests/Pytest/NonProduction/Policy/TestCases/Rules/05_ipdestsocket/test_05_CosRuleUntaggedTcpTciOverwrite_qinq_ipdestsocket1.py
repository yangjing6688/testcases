...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     ...
     def test_05_IpDestSocket_CoS_Policy_Rule_Untagged_TCP_Packet_with_TCI_Overwrite(self):
         ...
         print('  (Verification_10) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         ...
         print('  (Verification_11) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_4.')
         ...
         print('  (Verification_12) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')

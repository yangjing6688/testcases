...
class CosRuleTaggedTests(PolicyBase):
     ...
     def test_02_IpProto_CoS_Policy_Rule_Tagged_Packet_without_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_icmp)
         print('  (Verification_13) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_14) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_15) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_16) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_udp)
         print('  (Verification_17) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_tcp)
         print('  (Verification_18) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_icmp)
         print('  (Verification_19) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_20) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_21) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         ...
         print('  (Verification_22) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_udp)
         print('  (Verification_23) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_tcp)
         print('  (Verification_24) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Tagged_IPv6_Next_Header_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a,self.tb.config.proto_icmp)

...
class CosRulePriorityTaggedTests(PolicyBase):
     ...
     @mark.P3
     @mark.Policy_Rules
     @mark.Policy_IpTos_Rules
     def test_06_IPToS_CoS_Policy_Rule_Priority_Tagged_Packet_without_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_iptos_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_disabled.'''
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_a)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_b)
         ...
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_a)
         print('  (Verification_6) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_b)
         print('  (Verification_7) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_a)
         print('  (Verification_8) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_2.')
         self.localPolicyUdks.Transmit_100_Priority_Tagged_IP_ToS_Frames_and_Verify_Priority_Has_NOT_Changed(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_2,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.tos_b)

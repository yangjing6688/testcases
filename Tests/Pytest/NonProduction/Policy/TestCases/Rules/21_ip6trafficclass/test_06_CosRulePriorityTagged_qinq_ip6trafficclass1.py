...
class CosRulePriorityTaggedTests(PolicyBase):
     ...
     def test_06_Ip6TrafficClass_CoS_Policy_Rule_Priority_Tagged_Packet_without_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_ipttl_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_frames_when_TCI-Overwrite_is_disabled.'''

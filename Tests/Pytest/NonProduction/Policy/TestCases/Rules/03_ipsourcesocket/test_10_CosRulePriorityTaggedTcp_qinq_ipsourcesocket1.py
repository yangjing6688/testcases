...
class CosRulePriorityTaggedTcpTests(PolicyBase):
     ...
     def test_10_IpSourceSocket_CoS_Policy_Rule_Priority_Tagged_TCP_Packet_without_TCI_Overwrite(self):

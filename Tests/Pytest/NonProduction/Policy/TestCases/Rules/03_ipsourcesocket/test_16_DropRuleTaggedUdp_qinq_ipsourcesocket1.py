...
class DropRuleTaggedUdpTests(PolicyBase):
     ...
     def test_16_IpSourceSocket_Policy_Drop_Rule_Tagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_ipsourcesocket_policy_drop_rule_discards_tagged_packets.'''

...
class ClearRuleUntaggedUdpTests(PolicyBase):
     ...
     def test_22_IpSourceSocket_Policy_Clear_Drop_Rule_Untagged_UDP_Packet(self):
         '''[Documentation]  Test_Objective: Verify_traffic_passes_again_after_removing_an_ipsourcesocket_policy_drop_rule.'''
         ...
         self.localPolicyUdks.Remove_Policy_Rule_IpSourceSocket(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,self.tb.config.l4_port_b)
         self.localPolicyUdks.policy_verify_rule_ipsourcesocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,drop=True)
         self.localPolicyUdks.policy_verify_rule_ipsourcesocket_exists(self.tb.config.netelem1.name,self.tb.config.profile_a,self.tb.config.src_ip_a,self.tb.config.l4_port_b,drop=True)
         time.sleep(int(self.tb.config.policy_delay))

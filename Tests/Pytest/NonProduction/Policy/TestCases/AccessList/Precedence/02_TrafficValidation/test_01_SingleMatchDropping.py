...
class SingleMatchDroppingTests(PolicyBase):
    ...
    @mark.NIGHTLY
    @mark.NO30_6    
    def test_01_Access_List_Single_Match_Full_Mask_Dropping_Tests(self):
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(  self.tb.config.netelem1.name,self.tb.config.profile_a,
                                                                       'dropicmptype')
        ...
        print('(Verification_4a) Verify_100_ICMP (type_8_code_0) frames_were_sent_and_NOT_received.')
        ...
        print('Verification_4b) Verify_100_ICMP (type_3_code_0) frames_were_sent_and_received.')
        ...
        print('(Verification_4c) Verify_100_TCP_frames_were_sent_and_received.')
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,self.tb.config.profile_a,'dropether')
        ...
        print('  (Verification_5b) Verify_100_ethertype (0x0800) frames_were_sent_and_received.')
    ...
    #        Transmit_100_Untagged_IPv6_ICMP_Frames_and_Verify_NOT_Received
    #          self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    #          self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,   icmp_type=222_code=173
    #
    #   print('  (Verification_6b) Verify_100_IPV6_ICMP_frames_type/code_were_sent_and_received
    #        Transmit_100_Untagged_IPv6_ICMP_Frames_and_Verify_Priority_Changed
    #          self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    ...
    #        Transmit_100_Untagged_IPv6_Frames_and_Verify_Received
    #          self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(self.tb.config.netelem1.name, self.tb.config.profile_a,'dropipdestsocket')
    
        print('(Verification_7a) Verify_100_TCP_frames_with_dst_ip_a:l4_port_c_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_7b) Verify_100_TCP_frames_with_non-dst_ip_a:l4_port_b_were_sent_and_received.')
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(self.tb.config.netelem1.name,self.tb.config.profile_a,'dropipfrag')
        ...
        print('  (Verification_8b) Verify_100_frames_that_are_not_fragmented_were_sent_and_received.')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_b)
    #
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(self.tb.config.netelem1.name,self.tb.config.profile_a,'dropipproto')
        ...
        print('(Verification_9b) Verify_100_ipproto_TCP (6) frames_were_sent_and_received.')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_a,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(self.tb.config.netelem1.name,self.tb.config.profile_a,'dropipSsock')
    
        print('(Verification_10a) Verify_100_ip_Source_Socket_frames (src_ip_a:l4_port_a) were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_10b) Verify_100_ip_Source_Socket_frames (src_ip_a:l4_port_a) were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_10c) Verify_100_TCP_Source_Socket_frames (src_ip_a:l4_port_b) were_sent_and_received (priority_remains_3)')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_c)
    
        print('(Verification_10d) Verify_100_UDP_Source_Socket_frames (src_ip_a:l4_port_b) were_sent_received (priority_remains_3)')
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(self.tb.config.netelem1.name,   self.tb.config.profile_a,   'dropiptos')
    
        print('(Verification_11a) Verify_100_frames_iptos_of_31_were_sent_and_NOT_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_NOT_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c,  tos='31')
    
        print('(Verification_11b) Verify_100_frames_iptos_of_15_were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,self.tb.config.profile_a,'dropipttl')
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name, self.tb.config.profile_a,'droptcpDportIP')
        ...
        print('(Verification_13b) Verify_100_UDP_frames_dest:(l4_port_c:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_13c) Verify_100_TCP_frames_dest:(l4_port_a:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('(Verification_13d) Verify_100_UDP_frames_dest:(l4_port_b:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Received(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'droptcpSportIP')
        ...
        print('(Verification_14b) Verify_100_UDP_frames_src:(l4_port_c:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,     self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_14c) Verify_100_TCP_frames_src:(l4_port_a:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
        ...
        print('(Verification_14d) Verify_100_UDP_frames_src:(l4_port_b:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'dropudpDportIP')
        ...
        print('(Verification_15b) Verify_100_TCP_frames_dest:(l4_port_c:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('  (Verification_15c) Verify_100_UDP_frames_dest:(l4_port_a:dst_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('(Verification_15d) Verify_100_TCP_frames_dest:(l4_port_a:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    #
    ...
    #
        ...
        self.localPolicyUdks.change_policy_access_list_profile_index(   self.tb.config.netelem1.name,   self.tb.config.profile_a,   'dropudpSportIP')
        ...
        print('(Verification_16b) Verify_100_TCP_frames_dest:(l4_port_a:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_a,    self.tb.config.l4_port_c)
    
        print('(Verification_16c) Verify_100_UDP_Frames_dest:(l4_port_b:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_UDP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)
    
        print('(Verification_16d) Verify_100_TCP_frames_dest:(l4_port_b:src_ip_a) were_sent_and_received')
        self.localPolicyUdks.Transmit_100_Untagged_TCP_Frames_and_Verify_Priority_Changed(
              self.tb.config.tgen_ports.netelem1.port_a,  self.tb.config.tgen_ports.netelem1.port_b,    self.tb.config.src_mac_a,    self.tb.config.dst_mac_a,    self.tb.config.vlan_a,
              self.tb.config.priority_3,   self.tb.config.src_ip_a,    self.tb.config.dst_ip_a,    self.tb.config.l4_port_b,    self.tb.config.l4_port_a)

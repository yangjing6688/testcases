...
class CosRulePriorityTaggedTcpTciOverwriteTests(PolicyBase):
     @mark.EXOS
     @mark.P4
     def test_09_IpDest_CoS_Policy_Rule_QinQ_Priority_Tagged_TCP_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_TCP_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_c,self.tb.config.l4_port_a,self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_TCP_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.mcast_mac,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_c,self.tb.config.l4_port_a,self.tb.config.l4_port_c)

...
class CosRuleUntaggedTcpTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_06_IpDest_CoS_Policy_Rule_QinQ_Untagged_TCP_Packet_without_TCI_Overwrite(self):

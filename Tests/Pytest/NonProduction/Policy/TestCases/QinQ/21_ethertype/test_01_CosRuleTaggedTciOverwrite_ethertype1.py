...
class CosRuleTaggedTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_01_EtherType_CoS_Policy_Rule_QinQ_Tagged_UDP_Packet_with_TCI_Overwrite(self):
         '''[Documentation]  Test_Objective: Verify_ethertype_policy_rules_associate_traffic_correctly_for_unlearned/learned unicast, broadcast_and_multicast_QinQ_frames_when_TCI-Overwrite_is_enabled.'''
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPv4_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_4.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPv6_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_c,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_a)
         print('  (Verification_3) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPX_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.dst_mac_a,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.type_ipx)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPv4_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPX_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.bcast_mac,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.type_ipx)
         print('  (Verification_10) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPv4_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IPX_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_c,self.tb.config.mcast_mac,self.tb.config.vlan_list_a,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.type_ipx)

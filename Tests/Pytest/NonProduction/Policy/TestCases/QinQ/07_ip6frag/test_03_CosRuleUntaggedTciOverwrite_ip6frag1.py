...
class CosRuleUntaggedTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_03_Ip6Frag_CoS_Policy_Rule_QinQ_Untagged_Packet_with_TCI_Overwrite(self):

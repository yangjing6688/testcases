...
class CosRuleUntaggedTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P3
     def test_04_Ip6TrafficClass_CoS_Policy_Rule_QinQ_Untagged_Packet_without_TCI_Overwrite(self):

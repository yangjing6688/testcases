...
class CosRuleUntaggedTcpTciOverwriteTests(PolicyBase):
     @mark.EXOS
     @mark.P3
     def test_05_IpSourceSocket_CoS_Policy_Rule_Untagged_TCP_Packet_with_TCI_Overwrite(self):

...
class CosRuleUntaggedTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_04_IpFrag_CoS_Policy_Rule_QinQ_Untagged_Packet_without_TCI_Overwrite(self):

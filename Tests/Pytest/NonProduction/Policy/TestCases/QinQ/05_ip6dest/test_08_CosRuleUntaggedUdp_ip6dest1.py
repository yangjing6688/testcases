...
class CosRuleUntaggedUdpTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_08_Ip6Dest_CoS_Policy_Rule_QinQ_Untagged_UDP_Packet_without_TCI_Overwrite(self):

...
class CosRuleUntaggedUdpTciOverwriteTests(PolicyBase):
     ...
     @mark.EXOS
     @mark.P2
     def test_07_Ip6Dest_CoS_Policy_Rule_QinQ_Untagged_UDP_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IPv6_UDP_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,self.tb.config.l4_port_a,self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IPv6_UDP_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,self.tb.config.l4_port_a,self.tb.config.l4_port_c)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Untagged_IPv6_UDP_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_a,self.tb.config.priority_7,self.tb.config.vlan_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.src_ip6_a,self.tb.config.dst_ip6_b,self.tb.config.l4_port_a,self.tb.config.l4_port_c)

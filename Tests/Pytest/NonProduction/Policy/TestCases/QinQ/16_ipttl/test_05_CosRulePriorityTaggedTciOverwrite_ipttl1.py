...
class CosRulePriorityTaggedTciOverwriteTests(PolicyBase):
     @mark.EXOS
     @mark.P4
     def test_05_IpTTL_CoS_Policy_Rule_QinQ_Priority_Tagged_Packet_with_TCI_Overwrite(self):
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.dst_mac_a,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_a)
         print('  (Verification_2) Verify_100_unlearned_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.dst_mac_a,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_b)
         ...
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.bcast_mac,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_a)
         print('  (Verification_6) Verify_100_broadcast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.bcast_mac,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_b)
         print('  (Verification_7) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_5.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_a,self.tb.config.mcast_mac,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_b,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_a)
         print('  (Verification_8) Verify_100_multicast_frames_were_sent_and_received, with_a_priority_value_of_3.')
         self.localPolicyUdks.Transmit_100_QinQ_Tagged_IP_TTL_Frames_and_Verify_Priority(self.tb.config.tgen_ports.netelem1.port_a,self.tb.config.tgen_ports.netelem1.port_b,self.tb.config.src_mac_b,self.tb.config.mcast_mac,self.tb.config.vlan_list_b,self.tb.config.vlan_list_a,self.tb.config.prio_list_a,self.tb.config.prio_list_d,self.tb.config.tpid_list_a,self.tb.config.tpid_list_a,self.tb.config.src_ip_a,self.tb.config.dst_ip_a,self.tb.config.ttl_b)

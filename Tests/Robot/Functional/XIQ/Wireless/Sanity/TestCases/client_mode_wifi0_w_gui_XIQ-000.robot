...
#                 Client Mode Wifi0 End to End with Web GUI
#########################################################################################################
...
Test1: Advance Onboard AP1 and AP2 - TCXM-15129 - TCXM-15131
    ...
    [Tags]             tcxm_15129     tcxm_15131    development     test1     test
...
Test2: Config AP1 and AP2 Capwap to Report AIO - TCXM-15129 - TCXM-15131
    ...
    [Tags]              tcxm_15129     tcxm_15131     development    test2      test
    Depends On          Test1
    ${aps}=      Create List        ${ap1}        ${ap2}
    FOR    ${ap}    IN    @{aps}
...
Test3: Check AP1 and AP2 Status On UI - TCXM-15129 - TCXM-15131
    ...
    [Tags]              tcxm_15129    tcxm_15131      development     test3       test
    Depends On          Test2
    ${aps}=      Create List        ${ap1}        ${ap2}
...
Test4: Create Policy and Update Policy to AP1 and AP2 - CXM-15129 - TCXM-15131 - TCXM-16058
    ...
    [Tags]              tcxm_15129     tcxm_15131    tcxm_16058     development     test4      test
    Depends On          Test3
...
Test5: Setup WIFI on STA2 and Connect to AP2 - TCXM-16058
    ...
    [Tags]              tcxm_16058       development        test5      test
    Depends On          Test4
    ${mu}                 set variable               ${mu2}
...
Test6: Verify Connection - TCXM-16058
    [Documentation]     Setup WIFI on STA2 and Connect to AP2 on Client Mode
    [Tags]              tcxm_16058     development    test6      test
    Depends On          Test5
    ${mu}               set variable        ${mu2}

...
&{AP_TEMPLATE_2_WIFI0}   radio_status=On   radio_profile=radio_ng_11ax-2g   client_mode=Disable   client_access=Enable   backhaul_mesh_link=Disable   sensor=UIDisable   enable_SDR=Disable
&{AP_TEMPLATE_2_WIFI1}   radio_status=On   radio_profile=radio_ng_11ax-5g   client_mode=Disable   client_access=Enable   backhaul_mesh_link=Disable   sensor=UIDisable
&{AP_TEMPLATE_2_WIFI2}   radio_status=On   radio_profile=radio_ng_11ax-6g                         client_access=Enable   backhaul_mesh_link=Disable   sensor=Disable
...
Step1: Verify device template wireless interface wifi0-1-2 details and wired interface details
    ...
    &{AP_TEMPLATE_1}          create dictionary     wifi0_configuration=&{AP_TEMPLATE_1_WIFI0}   wifi1_configuration=&{AP_TEMPLATE_1_WIFI1}
...
Step2: Verify device configure wireless interface wifi0-1-2 details and wired interface details
    ...
    Lists Should Be Equal     ${ITEM_1[2]}     ${ITEM_2[2]}

...
Test1: Onboard Sensor AP
    ...
    ${ONBOARD_RESULT}=          Onboard Device      ${ap1.serial}           ${ap1.cli_type}       location=${ap1.location}
...
Test2: Onboard AP to Generate DoS Deauthentication
    ...
    ${ONBOARD_RESULT}=          Onboard Device      ${ap2.serial}           ${ap2.cli_type}       location=${ap2.location}

...
&{WIRELESS_PPSK_NW_CLOUD_SINGLE}     ssid_name=${SINGLE_CLOUD_NW_SSID}    network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE_CLOUD_SINGLE}
&{WIRELESS_PPSK_NW_LOCAL_BULK}       ssid_name=${BULK_LOCAL_NW_SSID}      network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE_LOCAL_BULK}
&{WIRELESS_PPSK_NW_LOCAL_SINGLE}     ssid_name=${SINGLE_LOCAL_NW_SSID}    network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE_LOCAL_SINGLE}
&{WIRELESS_OPEN_PPSK_NW_CLOUD_CWP}   ssid_name=${CLOUD_CWP_NW_SSID}       network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE_CWP_USER_GROUP}
&{WIRELESS_CLIENT_PER_PPSK}          ssid_name=${CLIENT_PER_PPSK_SSID}    network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{CLIENT_PER_PPSK_PROFILE}
&{WIRELESS_PPSK_NW_CLOUD_SINGLE1}    ssid_name=${SINGLE_CLOUD_NW_SSID1}   network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE_CLOUD_SINGLE1}
&{LOCAL_PPSK_NETWORK1}               ssid_name=${LOCAL_DB_PPSK_SSID1}     network_type=Standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}     auth_profile=&{PPSK_AUTH_PROFILE1}
########
...
&{PPSK_AUTH_PROFILE_CLOUD_SINGLE}     auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_CLOUD_SIGNLE}   user_access_settings_config=None   additional_settings_config=None
&{PPSK_AUTH_PROFILE_CLOUD_SINGLE1}    auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_CLOUD_SIGNLE1}  user_access_settings_config=None   additional_settings_config=None
&{PPSK_AUTH_PROFILE_LOCAL_BULK}       auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_LOCAL_BULK}     user_access_settings_config=None   additional_settings_config=None
&{PPSK_AUTH_PROFILE_LOCAL_SINGLE}     auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_LOCAL_SINGLE}   user_access_settings_config=None   additional_settings_config=None
&{PPSK_AUTH_PROFILE_CWP_USER_GROUP}   auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_CLOUD_CWP}      user_access_settings_config=None   additional_settings_config=None
&{CLIENT_PER_PPSK_PROFILE}            auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING1}          cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_CLOUD_BULK1}    user_access_settings_config=None   additional_settings_config=None

&{PPSK_AUTH_PROFILE1}                 auth_type=PPSK   key_encryption=&{PPSK_KEY_ENCRYPTION1}   ppsk_config=&{PPSK_SETTING_DEFAULT}   cwp_config=&{PPSK_CWP_DEFAULT}   user_group_config=&{USER_GROUP_LOCAL1}         user_access_settings_config=None   additional_settings_config=None
...
&{USER_GROUP_CLOUD_SIGNLE1}    group_name=${SINGLE_CLOUD_USER_GROUP1}   user_group_profile=&{USER_GROUP_PROFILE_CLOUD_SINGLE1}
...
&{OPEN_CWP_NW1}   ssid_name=${CLOUD_CWP_OPEN_NW_SSID}     network_type=standard    ssid_profile=&{BORADCAST_SSID_DEFAULT}    auth_profile=&{OPEN_AUTHENTICATION_CWP_PROFILE1}

&{OPEN_AUTHENTICATION_CWP_PROFILE1}     auth_type=Open    cwp_profile=&{OPEN_CWP_PROFILE1}

&{OPEN_CWP_PROFILE1}    enable_cwp=Enable   captive_web_portal=Enable    enable_self_reg=Enable   return_aerohive_private_psk=Enable   enable_upa=Disable    user_auth_on_captive_web_portal=Disable
...                     open_cwp_config=&{CWP_CONFIG1}

&{CWP_CONFIG1}         captive_web_portal_name=${SELF_REG_RETURN_PPSK_CWP}     ppsk_settings=&{PPSK_SETTINGS2}
&{PPSK_SETTINGS1}      choose_access_ssid=${CLOUD_CWP_NW_SSID}      choose_ppsk_server=Cloud PPSK Registration Server    employee_approval=Disable
&{PPSK_SETTINGS2}      choose_access_ssid=${CLOUD_CWP_NW_SSID}      choose_ppsk_server=Cloud PPSK Registration Server    employee_approval=Enable    domain=gmail.com
...
...                     password=extremexxter                 pass-generate=Disable                    description=single user username password verification
...                     deliver_pass=${MAIL_ID1}

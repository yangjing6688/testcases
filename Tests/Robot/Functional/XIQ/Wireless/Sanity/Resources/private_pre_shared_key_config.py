...
OPEN_SSID = f"default_open_ssid_{RANDOM_INT}"
...
self_reg_user1_info = {'email': PPSK_MAIL_ID, 'ccode': '91', 'ph_num': '8971766359', 'visitor_email': MAIL_ID2}
BORADCAST_SSID_DEFAULT = {'WIFI0': 'Enable', 'WIFI1': 'Enable'}

## User Profiles
bulk_users_info1 = {'user-type': 'bulk', 'username_prefix': 'user_', 'no_of_accounts': '2',
                    'email_user_account_to': PPSK_MAIL_ID}
bulk_users_info2 = {'user-type': 'bulk', 'username_prefix': 'user2_', 'no_of_accounts': '2',
                    'email_user_account_to': PPSK_MAIL_ID}
bulk_users_info3 = {'user-type': 'bulk', 'username_prefix': 'user100_', 'no_of_accounts': '1',
                    'email_user_account_to': PPSK_MAIL_ID}

single_user1_info = {'user-type': 'single', 'name': 'Symbol', 'organization': 'ExtremeNetworks',
                     'purpose_of_visit': 'guest',
                     'email_address': PPSK_MAIL_ID, 'phone_number': '+91 India-8971766359', 'user_name_type': 'Name',
                     'password': 'extremextreme', 'pass-generate': 'Disable',
                     'description': 'single user username password verification', 'deliver_pass': PPSK_MAIL_ID}

single_user3_info = {'user-type': 'single', 'name': 'Jims', 'organization': 'ExtremeNetworksA',
                     'purpose_of_visit': 'guest', 'email_address': PPSK_MAIL_ID,
                     ...
                     'deliver_pass': PPSK_MAIL_ID}

single_user2_info = {'user-type': 'single', 'name': 'Symbol1', 'organization': 'ExtremeNetworks',
                     'purpose_of_visit': 'guest',
                     'email_address': PPSK_MAIL_ID, 'phone_number': '+504 Honduras-8971766359',
                     'user_name_type': 'Phone Number',
                     'password': 'extremextreme', 'pass-generate': 'Disable',
                     'description': 'single user username password verification',
                     'deliver_pass': PPSK_MAIL_ID}
...
DB_LOC_CLOUD_PPSK_DEFAULT = {'pass_db_loc': 'CLOUD', 'pass_type': 'ppsk', 'cwp_register': 'Disable',
                             'pcg_use': 'Disable'}
...
USER_GROUP_PROFILE_CLOUD_SINGLE = {'user_group_config': DB_LOC_CLOUD_PPSK_DEFAULT, 'users_config': single_user1_info,
                                   'passwd_settings': 'None', 'expiration_settings': 'None',
...
USER_GROUP_CLOUD_SINGLE1 = {'group_name': SINGLE_CLOUD_USER_GROUP1,
                            'user_group_profile': USER_GROUP_PROFILE_CLOUD_SINGLE1}
...
WIRELESS_OPEN_PPSK_NW_CLOUD_CWP = {'ssid_name': CLOUD_CWP_NW_SSID, 'network_type': 'Standard',
                                   'ssid_profile': BORADCAST_SSID_DEFAULT,
                                   'auth_profile': PPSK_AUTH_PROFILE_CWP_USER_GROUP}
...
WIRELESS_PPSK_NW_CLOUD_SINGLE1 = {'ssid_name': SINGLE_CLOUD_NW_SSID1, 'network_type': 'Standard',
                                  'ssid_profile': BORADCAST_SSID_DEFAULT,
                                  'auth_profile': PPSK_AUTH_PROFILE_CLOUD_SINGLE1}

...
# Date          : May 10th 2023
# Description   : XIQ-14550 AP3000 Regulatory Support
#
# Topology:
# Host ----- XIQ
#
...
#  ----------------------------------
#  robot -v TOPO:topology.yaml -v ENV:environment.yaml -v TESTBED:SJ/Dev/xiq_sj_tb0_all.yaml -i tcxm-20828 -v AP3000_Mode:3K_6GHz -d /home/bsochor/logs -T AP5010xxx.robot
#
#
#  ---------------------
#  ${AP3000_Mode}=3K_2GHz, assumption: WiFi0 is set to 2GHz; DFS is enabled on 5GHz
#  ${AP3000_Mode}=3K_6GHz, assumption: WiFi0 is set to 6GHz, 20MHz; DFS is disabled on 5GHz
...
# Test70 - TCXM-42002 - Verify: AP Can Be Configured To Morocco
#             Verifies AP's functionality after being set to Morocco
# Test71 - TCXM-42002 - Verify: AP Can Be Configured To Myanmar
#             Verifies AP's functionality after being set to Myanmar
# Test72 - TCXM-42002 - Verify: AP Can Be Configured To Guatemala
#             Verifies AP's functionality after being set to Guatemala
# Test73 - TCXM-42002 - Verify: AP Can Be Configured To Costa Rica
#             Verifies AP's functionality after being set to Costa Rica
# Test74 - TCXM-42002 - Verify: AP Can Be Configured To Honduras
#             Verifies AP's functionality after being set to Honduras
# Test75 - TCXM-20855 - Verify: AP Can Be Configured To Chile
#             Verifies AP's functionality after being set to Chile
# Test76 - TCXM-20855 - Verify: AP Can Be Configured To Peru
#             Verifies AP's functionality after being set to Peru
# Test77 - TCXM-20769 - Verify: A Country Cannot Be Reconfigured To "United States (840)"
#             Verifies that AP set to World region cannot be configured to United States.
# Test78 - TCXM-20771 - Verify: A Country Cannot Be Reconfigured To "Canada (124)"
#             Verifies that AP set to World region cannot be configured to Canada.
# Test79 - TCXM-20768 - Verify: "United States (840)" Country Cannot Be Reconfigured
#             Verifies that AP congigured to US cannot be reconfigured to a different country
# Test80 - TCXM-20770 - Verify: "Canada (124)" Country Cannot Be Reconfigured
#             Verifies that AP congigured to Canada cannot be reconfigured to a different country
# Test81 - TCXM-34876 - Verify: D360 Channels Can Be Configured
...
*** Test Cases ***
 Test1 - TCXM-20804 - Verify: AP Can Be Configured To Albania
    ...
    [Tags]                  tcxm-20804    development     eu1
    ...
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    140
    ...
    Run Keyword If    "${AP3000_Mode}" == "3K_6GHz"    SetWiFi_0_1_2_Channel    ${NEW_WiFi2_CHANNEL}    ${NEW_WiFi1_CHANNEL}    ${NEW_WiFi2_CHANNEL}
    ...     ELSE      SetWiFi_0_1_2_Channel    ${NEW_WiFi0_CHANNEL}    ${NEW_WiFi1_DFS_CHANNEL}    ${NEW_WiFi2_CHANNEL}
...
Test4 - TCXM-20829 - Verify: AP Can Be Configured To Bulgaria
    ...
    [Tags]                  tcxm-20829    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test5 - TCXM-20830 - Verify: AP Can Be Configured To Bosnia-Herzegovina
    ...
    [Tags]                  tcxm-20830    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test6 - TCXM-20772 - Verify: AP Can Be Configured To Puerto Rico
    ...
    [Tags]                  tcxm-20772    development   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
    ...
    ${NEW_WiFi1_CHANNEL}          Set Variable    48
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    144
...
Test7 - TCXM-42002 - Verify: AP Can Be Configured To Colombia
    [Documentation]         AP's country code is changed to Colombia, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000   colombia
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test8 - TCXM-20786 - Verify: AP Can Be Configured To Australia
    ...
    [Tags]                  tcxm-20786    development   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test18 - TCXM-20849 - Verify: AP Can Be Configured To Romania
    ...
    [Tags]                  tcxm-20849    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test19 - TCXM-20838 - Verify: AP Can Be Configured To Hungary
    ...
    [Tags]                  tcxm-20838    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test20 - TCXM-20854 - Verify: AP Can Be Configured To Switzerland
    ...
    [Tags]                  tcxm-20854    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test21 - TCXM-20831 - Verify: AP Can Be Configured To Croatia
    ...
    [Tags]                  tcxm-20831    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test22 - TCXM-20832 - Verify: AP Can Be Configured To Cyprus
    ...
    [Tags]                  tcxm-20832    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test23 - TCXM-20833 - Verify: AP Can Be Configured To Czech Republic
    ...
    [Tags]                  tcxm-20833    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test24 - TCXM-20834 - Verify: AP Can Be Configured To Denmark
    ...
    [Tags]                  tcxm-20834    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test25 - TCXM-20835 - Verify: AP Can Be Configured To Estonia
    ...
    [Tags]                  tcxm-20835    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test26 - TCXM-20837 - Verify: AP Can Be Configured To Greece
    ...
    [Tags]                  tcxm-20837    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test27 - TCXM-20839 - Verify: AP Can Be Configured To Iceland
    ...
    [Tags]                  tcxm-20839    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   170
    ...          AND              Quit Browser
...
Test28 - TCXM-20840 - Verify: AP Can Be Configured To Ireland
    ...
    [Tags]                  tcxm-20840    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test29 - TCXM-20841 - Verify: AP Can Be Configured To Latvia
    ...
    [Tags]                  tcxm-20841    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test30 - TCXM-20843 - Verify: AP Can Be Configured To Liechtenstein
    ...
    [Tags]                  tcxm-20843    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test31 - TCXM-20858 - Verify: AP Can Be Configured To Lithuania
    ...
    [Tags]                  tcxm-20858    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test32 - TCXM-20844 - Verify: AP Can Be Configured To Luxembourg
    ...
    [Tags]                  tcxm-20844    development     eu1   last2
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test33 - TCXM-20845 - Verify: AP Can Be Configured To Macedonia
    ...
    [Tags]                  tcxm-20845    development     eu1   last2
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
    ...
    ${SHORT_COUNTRY}          Set Variable    North
    ${NEW_WiFi0_CHANNEL}      Set Variable    13
    ${NEW_WiFi1_CHANNEL}      Set Variable    48
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    140
    ${NEW_WiFi2_CHANNEL}      Set Variable    93
...
Test34 - TCXM-20846 - Verify: AP Can Be Configured To Malta
    ...
    [Tags]                  tcxm-20846    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test35 - TCXM-20847 - Verify: AP Can Be Configured To Montenegro
    ...
    [Tags]                  tcxm-20847    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test37 - TCXM-20850 - Verify: AP Can Be Configured To Serbia
    ...
    [Tags]                  tcxm-20850    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test38 - TCXM-20851 - Verify: AP Can Be Configured To Slovakia
    ...
    [Tags]                  tcxm-20851    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test39 - TCXM-20852 - Verify: AP Can Be Configured To Slovenia
    ...
    [Tags]                  tcxm-20852    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test40 - TCXM-20855 - Verify: AP Can Be Configured To Turkey
    ...
    [Tags]                  tcxm-20855    development     eu1
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test41 - TCXM-20779 - Verify: AP Can Be Configured To UK
    ...
    [Tags]                  tcxm-20779    development   ap-3000a    rerun
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test42 - TCXM-24874 - Verify: AP Can Be Configured To Georgia
    ...
    [Tags]                  tcxm-24874    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test43 - TCXM-24227 - Verify: AP Can Be Configured To New Zealand
    ...
    [Tags]                  tcxm-24227    development   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test60 - TCXM-39674 - Verify: AP Can Be Configured To Qatar
    ...
    [Tags]                  tcxm-39674    development   ap-4000    ap-5010    ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test61 - TCXM-39306 - Verify: AP Can Be Configured To U.A.E.
    ...
    [Tags]                  tcxm-39306    development    ap-5010    ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test62 - TCXM-39413 - Verify: AP Can Be Configured To Saudi Arabia
    ...
    [Tags]                  tcxm-39413    development   ap-5010   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test63 - TCXM-39371 - Verify: AP Can Be Configured To Brazil
    ...
    [Tags]                  tcxm-39371    development   ap-5010   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test64 - TCXM-39262 - Verify: AP Can Be Configured To Japan
    ...
    [Tags]                  tcxm-39262    development   ap-4000    ap-5010    ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test67 - TCXM-41231 - Verify: AP Can Be Configured To Malaysia
    ...
    [Tags]                  tcxm-41231    development   ap-5050   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
    ...
    ${NEW_WiFi0_CHANNEL}      Set Variable    13
    ${NEW_WiFi1_CHANNEL}      Set Variable    165
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    128
    ${NEW_WiFi2_CHANNEL}      Set Variable    93
...
Test69 - TCXM-42002 - Verify: AP Can Be Configured To Hong Kong
    ...
    [Tags]                  tcxm-42002    development   ap-5050   ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser
...
Test70 - TCXM-42002 - Verify: AP Can Be Configured To Morocco
    [Documentation]         AP's country code is changed to Morocco, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                  Set Variable    Morocco
    ${COUNTRY_CODE}             Set Variable    504
    ${NEW_WiFi0_CHANNEL}        Set Variable    13
    ${NEW_WiFi1_CHANNEL}        Set Variable    48
    ${NEW_WiFi1_DFS_CHANNEL}    Set Variable    64
    ${NEW_WiFi2_CHANNEL}        Set Variable    93
...
Test71 - TCXM-42002 - Verify: AP Can Be Configured To Myanmar
    [Documentation]         AP's country code is changed to Myanmar, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                  Set Variable    Myanmar
    ${COUNTRY_CODE}             Set Variable    104
    ${NEW_WiFi0_CHANNEL}        Set Variable    13
    ${NEW_WiFi1_CHANNEL}        Set Variable    48
    ${NEW_WiFi1_DFS_CHANNEL}    Set Variable    140
    ${NEW_WiFi2_CHANNEL}        Set Variable    93
...
Test72 - TCXM-42002 - Verify: AP Can Be Configured To Guatemala
    [Documentation]         AP's country code is changed to Guatemala, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                  Set Variable    Guatemala
    ${COUNTRY_CODE}             Set Variable    320
    ${NEW_WiFi0_CHANNEL}        Set Variable    11
    ${NEW_WiFi1_CHANNEL}        Set Variable    165
    ${NEW_WiFi1_DFS_CHANNEL}    Set Variable    144
    ${NEW_WiFi2_CHANNEL}        Set Variable    229
...
Test73 - TCXM-42002 - Verify: AP Can Be Configured To Costa Rica
    [Documentation]         AP's country code is changed to Costa Rica, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                  Set Variable    Costa Rica
    ${COUNTRY_CODE}             Set Variable    188
    ${SHORT_COUNTRY}            Set Variable    Rica
    ${NEW_WiFi0_CHANNEL}        Set Variable    13
    ${NEW_WiFi1_CHANNEL}        Set Variable    165
    ${NEW_WiFi1_DFS_CHANNEL}    Set Variable    144
    ${NEW_WiFi2_CHANNEL}        Set Variable    229
...
Test74 - TCXM-42002 - Verify: AP Can Be Configured To Honduras
    [Documentation]         AP's country code is changed to Honduras and, channels set and results verified
    [Tags]                  tcxm-42002    development   ap-3000
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                  Set Variable    Honduras
    ${COUNTRY_CODE}             Set Variable    340
    ${NEW_WiFi0_CHANNEL}        Set Variable    11
    ${NEW_WiFi1_CHANNEL}        Set Variable    165
    ${NEW_WiFi1_DFS_CHANNEL}    Set Variable    144
    ${NEW_WiFi2_CHANNEL}        Set Variable    229
...
Test75 - TCXM-20855 - Verify: AP Can Be Configured To Chile
    [Documentation]         AP's country code is changed to Chile and result it verified on UI level
    [Tags]                  tcxm-20855    development     ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                Set Variable    Chile
    ${COUNTRY_CODE}           Set Variable    152
    ${NEW_WiFi0_CHANNEL}      Set Variable    13
    ${NEW_WiFi1_CHANNEL}      Set Variable    48
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    140
    ${NEW_WiFi2_CHANNEL}      Set Variable    93
...
Test76 - TCXM-20855 - Verify: AP Can Be Configured To Peru
    [Documentation]         AP's country code is changed to Peru and result it verified on UI level
    [Tags]                  tcxm-20855    development     ap-3000a
    [Teardown]   run keywords     Logout User
    ...          AND              Sleep   10
    ...          AND              Quit Browser

    ${COUNTRY}                Set Variable    Peru
    ${COUNTRY_CODE}           Set Variable    604
    ${NEW_WiFi0_CHANNEL}      Set Variable    13
    ${NEW_WiFi1_CHANNEL}      Set Variable    165
    ${NEW_WiFi1_DFS_CHANNEL}      Set Variable    144
    ${NEW_WiFi2_CHANNEL}      Set Variable    229

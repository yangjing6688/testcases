...
# create ppsk usergroup and set it suite variable
    ${PPSK_USER_GROUP_ID}=   create ppsk user group   ${PPSK_USERGROUP_GLOBAL}
...
TC-6677: Create PPSK User Group
    ...
    ${UG_ID}=  create ppsk user group  ${PPSK_USERGROUP}
    log     ${UG_ID}
...
TC-6676: PPSK-Get list of PPSK Gser Groups
    ...
    ${PPSK_USER_GROUPS_COUNT}=  get ppsk usergroups
...
TC-16308: Create PPSK User for a particular User Group with EMAIL and SMS
    ...
    ${PPSK_USER_ID}=  create ppsk user     ${PPSK_USER_GROUP_ID}  ${PPSK_USERNAME}
...
TC-16319: PPSK-Get list of PPSK Users
    ...
    ${PPSK_USERS_COUNT}=  get ppsk users   ${PPSK_USERNAME}
...
Test Suite Clean Up
    ...
    delete ppsk usergroup  ${UG_ID}
    delete ppsk usergroup   ${PPSK_USER_GROUP_ID}
    delete ppsk user   ${PPSK_USER_ID}

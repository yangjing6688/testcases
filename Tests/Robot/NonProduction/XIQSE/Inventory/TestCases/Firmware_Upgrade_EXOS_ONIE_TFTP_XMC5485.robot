...
# Description   : Test Suite for testing an EXOS ONIE TFTP firmware upgrade within XIQSE.
...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    onie    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    onie    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    onie    tftp    test3

...
# Description   : Test Suite for testing an VOSS SCP firmware upgrade within XIQSE.
#                 This is qTest TC-910 in the XIQSE project.
...
${VOSS_SCP_DEFINITION_FILENAME}     VOSS - SCP
${VOSS_SCP_TRANSFER_MODE}           SCP
${VOSS_UPGRADE_RELEASE_DIRECTORY}   v8.5.0.0
${VOSS_INT_DIRECTORY}               int028
${VOSS_DEV_TYPE}                    VOSS4400
${VOSS_UPGRADE_RELEASE_VERSION}     ${VOSS_DEV_TYPE}.8.5.0.0int028
${VOSS_FIRMWARE_VERSION}            8.5.0.0_B028
...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_910    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    scp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_910    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    scp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_910    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    scp    test3
...
Log In and Set Up Test
    ...
    ...    ${FIRMWARE_SCP_DIRECTORY}/${VOSS_UPGRADE_RELEASE}

...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              tcxe_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              tcxe_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              tcxe_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test3

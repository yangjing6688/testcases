...
# Description   : Test Suite for testing an EXOS Universal TFTP firmware upgrade within XIQSE.
#                 This is qTest TC-907 in the XIQSE project.
...
${DUT_IP}                           ${netelem7.ip}
${DUT_PROFILE}                      ${netelem7.profile}

${FIRMWARE_TFTP_DIRECTORY}          /tftpboot/firmware/images
${EXOS_RELEASE_BASE}                http://biltmore.extremenetworks.com/image_pool/public
${EXOS_TFTP_DEFINITION_FILENAME}    ExtremeXOS - TFTP
${EXOS_TFTP_TRANSFER_MODE}          TFTP
${EXOS_UPGRADE_RELEASE_PARENT}      31_7
${EXOS_INT_DIRECTORY}               31.7.0.8
${EXOS_UPGRADE_RELEASE_VERSION}     31.7.0.8
${EXOS_FILENAME_PREFIX}             summit_arm-
${EXOS_FILENAME_EXTENSION}          xos
${EXOS_FIRMWARE_VERSION}            31.7.0.8
...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test1

    Perform Firmware Upgrade and Confirm Success    ${DUT_IP}    ${EXOS_TFTP_TRANSFER_MODE}    ${EXOS_TFTP_DEFINITION_FILENAME}
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_907    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    universal    tftp    test3
...
Log In and Set Up Test
    ...
    Download Firmware to XIQ-SE and Confirm Success    ${XIQSE_IP_ADDRESS}  ${XIQSE_USERNAME}  ${XIQSE_PASSWORD}  ${FIRMWARE_TFTP_DIRECTORY}
    ...
    ...    ${FIRMWARE_TFTP_DIRECTORY}/${EXOS_FILENAME_PREFIX}${EXOS_UPGRADE_RELEASE_VERSION}.${EXOS_FILENAME_EXTENSION}

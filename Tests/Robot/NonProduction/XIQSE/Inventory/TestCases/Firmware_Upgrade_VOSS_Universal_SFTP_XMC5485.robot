...
# Description   : Test Suite for testing a VOSS Universal SFTP firmware upgrade within XIQSE.
#                 This is qTest TC-909 in the XIQSE project.
...
${VOSS_UPGRADE_RELEASE_VERSION}     5520.8.5.0.0int029
${VOSS_FIRMWARE_VERSION}            8.5.0.0_B029
${VOSS_IMAGE_EXTENSION}             voss
...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test3

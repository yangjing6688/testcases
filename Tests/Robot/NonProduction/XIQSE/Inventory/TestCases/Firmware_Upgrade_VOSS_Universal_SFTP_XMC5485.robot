...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              tcxe_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              tcxe_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              tcxe_909    xmc_5485    development    xiqse    inventory    firmware_upgrade    universal    voss    tftp    test3

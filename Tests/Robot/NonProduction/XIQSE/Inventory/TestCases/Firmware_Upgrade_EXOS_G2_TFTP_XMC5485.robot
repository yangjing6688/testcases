...
# Description   : Test Suite for testing an EXOS G2 TFTP firmware upgrade within XIQSE.
#                 This is qTest TC-905 in the XIQSE project.
...
${EXOS_INT_DIRECTORY}               31.5.1.6
${EXOS_UPGRADE_RELEASE_VERSION}     31.5.1.6
${EXOS_FILENAME_PREFIX}             summitX-
${EXOS_FILENAME_EXTENSION}          xos
${EXOS_UPGRADE_RELEASE}             31.5.1.6
${EXOS_FIRMWARE_VERSION}            31.5.1.6
...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    g2    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    g2    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_905    xmc_5485    development    xiqse    inventory    firmware_upgrade    exos    g2    tftp    test3

...
Test 1: Perform Upgrade Firmware
    ...
    [Tags]              xiqse_tc_911    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    tftp    test1
...
Test 2: Confirm Operations Panel Message
    ...
    [Tags]              xiqse_tc_911    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    tftp    test2
...
Test 3: Confirm Events
    ...
    [Tags]              xiqse_tc_911    xmc_5485    development    xiqse    inventory    firmware_upgrade    voss    tftp    test3

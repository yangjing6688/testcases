...
Test 1: Create Backup Configuration and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test1
...
Test 2: Confirm Operations Panel Message - Retrieved
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test2
...
Test 3: Confirm Events - Backup Configuration
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test3
...
Test 4: Navigate and Restore Configuration
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test4
...
Test 5: Verify Device Is Up After Restore
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test5
...
Test 6: Confirm Operations Panel Message - Restore
    [Documentation]     Confirms the operations panel contains the expected message
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test6

    Confirm Operations Panel Message For Type      Inventory Audit  ${OPS_PANEL_RESTORE}

Test 7: Confirm Events - Restore Configuration
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test7
...
Test 8: Delete Archive and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_868    xmc_5451    development    xiqse    acceptance    inventory    backup    restore    test8

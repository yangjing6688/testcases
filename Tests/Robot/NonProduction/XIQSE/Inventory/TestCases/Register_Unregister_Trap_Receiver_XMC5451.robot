...
Test 1: Register Trap Receiver
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test1    stacking
...
Test 2: Verify Register Trap Receiver Completes
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test2    stacking
...
Test 3: Create Backup After Register and Confirm Success
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test3    stacking
...
Test 4: Check Backup Configuration For Trap Receiver Entries Added
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test4    stacking
...
Test 5: Unregister Trap Receiver
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test5    stacking
...
Test 6: Verify Unregister Trap Receiver Completes
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    trap receiver    test6    stacking

    Verify Unregister Trap Receiver Completes    Trap Configuration

Test 7: Create Backup After Unregister and Confirm Success
    [Documentation]     Creates a backup configuration on selected device
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test7    stacking
...
Test 8: Check Backup Configuration To Verify Trap Receiver Entries Removed
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    trap receiver    test8    stacking
...
Test 9: Delete Archive
    ...
    [Tags]              nightly1    tcxe_874    xmc_5451    development    xiqse    acceptance    inventory    traps    test9    stacking

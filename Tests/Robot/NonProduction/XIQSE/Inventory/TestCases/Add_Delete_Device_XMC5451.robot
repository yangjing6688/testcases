...
Test 1: Add Device and Confirm Success
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test1
...
Test 2: Verify Operations Panel Operations Complete Successfully
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test2
...
Test 3: Verify Device Assigned Correct License
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test3
...
Test 4: Verify Device Statistics Enabled
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test4
...
Test 5: Verify Events For Add Device
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test5
...
Test 6: Verify Event For Device License
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test6
...
Test 7: Verify Add Actions Register Trap Receiver Successful
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test7
...
Test 8: Verify Add Actions Register Syslog Receiver Successful
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test8
...
Test 9: Verify Add Actions Add to Archive Successful
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test9
...
Text 10: Unregister Trap Receiver and Confirm Success
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test10
...
Text 11: Unregister Syslog Receiver and Confirm Success
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test11
...
Test 12: Delete Device and Confirm Success
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test12
...
Test 13: Verify Event for Delete Device
    ...
    [Tags]              xiqse_tc_951    xmc_5451    development    xiqse    acceptance    inventory    add_delete    test13

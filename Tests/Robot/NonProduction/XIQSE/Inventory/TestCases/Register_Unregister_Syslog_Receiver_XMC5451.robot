...
Test 1: Register Syslog Receiver
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test1
...
Test 2: Verify Register Syslog Receiver Completes
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test2
...
Test 3: Create Backup After Register and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test3
...
Test 4: Check Backup Configuration For Syslog Receiver Registered Entries Added
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test4
...
Test 5: Unregister Syslog Receiver
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test5
...
Test 6: Verify Unregister Syslog Receiver Completes
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test6

    Verify Register Syslog Receiver Completes    Syslog Configuration

Test 7: Create Backup After Unregister and Confirm Success
    [Documentation]     Creates a backup configuration on selected device
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test7
...
Test 8: Check Backup Configuration For Syslog Receiver Entries Removed
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test8
...
Test 9: Delete Archive
    ...
    [Tags]              nightly1    xiqse_tc_875    xmc_5451    development    xiqse    acceptance    inventory    syslog    test9

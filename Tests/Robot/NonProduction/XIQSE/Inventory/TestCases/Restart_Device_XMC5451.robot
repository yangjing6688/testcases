...
Test 1: Restart Switch
    ...
    [Tags]              nightly1    tcxe_876    xmc_5451    development    xiqse    acceptance    inventory    restart    test1
...
Test 2: Confirm Events
    ...
    [Tags]              nightly1    tcxe_876    xmc_5451    development    xiqse    acceptance    inventory    restart    test2
...
Test 3: Verify Device Is Up After Restart
    ...
    [Tags]              nightly1    tcxe_876    xmc_5451    development    xiqse    acceptance    inventory    restart    test3

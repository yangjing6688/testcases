...
Test 1: Perform Site Discovery with Auto Add Devices True
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test1
...
Test 2: Perform Site Discovery with Auto Add Devices False
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test2
...
Test 3: Perform Site Discovery with Add to Archive True
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test3
...
Test 4: Perform Site Discovery with Add to Archive False
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test4
...
Test 5: Perform Site Discovery with Add Trap Receiver True
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test5
...
Test 6: Perform Site Discovery with Add Trap Receiver False
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test6
...
Test 7: Perform Site Discovery with Add Syslog Receiver True
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test7
...
Test 8: Perform Site Discovery with Add Syslog Receiver False
    ...
    [Tags]              nightly1    tcxe_949    xmc_5451    development    xiqse    acceptance    sites    discovery    add_actions    test8

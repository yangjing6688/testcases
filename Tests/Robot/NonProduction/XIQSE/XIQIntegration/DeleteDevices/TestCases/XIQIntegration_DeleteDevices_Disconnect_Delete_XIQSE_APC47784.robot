...
# Description   : Test Suite for testing device deletion from XIQSE when XIQSE has been deleted and re-added,
...
#                 This is qTest test case TC-10312 in project CSIT:
#                   TC-10312: XIQSE Delete Devices - Disconnect - Delete XIQSE
...
*** Test Cases ***
Test 1: Delete Device - XIQSE Deleted and Re-Added
    [Documentation]  Confirms a device deleted from XIQSE is removed from XIQ after sharing has been disabled and re-enabled
    [Tags]           nightly2    release_testing    tccs_10312    apc_47884    development    xiqse    xiq_integration    delete_device    disconnect    delete_xiqse    test1
    ...
    Confirm Device Removed From XIQ             ${XIQSE_SERIAL}
...
Test 2: Delete Device With Note - XIQSE Deleted and Re-Added
    [Documentation]  Confirms a device deleted from XIQSE which has a note is removed from XIQ after disconnected via sharing
    [Tags]           nightly2    release_testing    tccs_10312    apc_47884    development    xiqse    xiq_integration    delete_device    disconnect    delete_xiqse    test2
...
Test 3: Delete Archived Device - XIQSE deleted and re-added
    [Documentation]  Confirms an archived device deleted from XIQSE is removed from XIQ after disconnected via sharing
    [Tags]           nightly2    release_testing    tccs_10312    apc_47884    development    xiqse    xiq_integration    delete_device    disconnect    delete_xiqse    test3

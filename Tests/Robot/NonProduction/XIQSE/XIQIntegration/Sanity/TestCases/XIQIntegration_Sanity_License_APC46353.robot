...
Test 1: Check Baseline License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test1
...
Test 2: Onboard XIQSE to XIQ and Check License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test2
...
Test 3: Create Pilot Device and Check License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test3
...
Test 4: Create Navigator Device and Check License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test4
...
Test 5: Delete Pilot Device and Check License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test5
...
Test 7: Remove XIQSE from XIQ and Check License Counts
    ...
    [Tags]              csit_tc_11877    apc_46353    development    xiqse    xiq_integration    license_sanity    test7

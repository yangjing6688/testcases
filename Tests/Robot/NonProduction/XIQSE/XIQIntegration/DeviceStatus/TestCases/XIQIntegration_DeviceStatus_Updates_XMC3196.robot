...
Test 1: Confirm Connected Device Has Correct Status In XIQSE and XIQ
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test1
...
Test 2: Confirm Disconnected Device Has Correct Status In XIQSE and XIQ
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test2
...
Test 3: Confirm Re-connected Device Has Correct Status In XIQSE and XIQ
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test3
...
Test 4: Confirm XIQ Site Engine and XIQSE-Managed Device Status When Sharing Disabled
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test4
...
Test 5: Confirm XIQ Site Engine and XIQSE-Managed Device Status When Sharing Re-enabled - Device Down
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test5
...
Test 6: Confirm XIQ Site Engine and XIQSE-Managed Device Status When Sharing Re-enabled - Device Up
    ...
    [Tags]              nightly2    release_testing    csit_tc_8995    xmc_3196    development    xiqse    xiq_integration    device_status    updates    test6

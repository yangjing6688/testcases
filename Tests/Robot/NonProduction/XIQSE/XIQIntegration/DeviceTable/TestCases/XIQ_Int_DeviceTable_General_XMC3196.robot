...
TC-53136: Add XIQ Site Engine Using Auto Onboard Button
    ...
    [Tags]              csit_tc_9519    xmc_3196    development    xiqse    xiq_integration    onboard    test1
...
TC-52225: Add Device to XIQSE - Unique Serial Number
    ...
    [Tags]              csit_tc_9070    xmc_3196    development    xiqse    xiq_integration     test2
    Depends On          test1
...
#    [Tags]              csit_tc_9051    xmc_3196    development    xiqse    xiq_integration     test3
#    Depends On          test1
#
...
TC-52227: Add XIQ Site Engine device to XIQSE
    ...
    [Tags]              csit_tc_9035    xmc_3196    development    xiqse    xiq_integration     test4
    Depends On          test1
...
TC-52427: Delete XIQ Site Engine Device from XIQSE (already onboarded to XIQ)
    ...
    [Tags]              csit_tc_9025    xmc_3196    development    xiqse    xiq_integration     test5
...
TC-52228: Delete Device from XIQSE (already onboarded to XIQ)
    [Documentation]     Confirms when a device is deleted in XIQ-SE, it is removed from XIQ
    [Tags]              csit_tc_9012    xmc_3196    development    xiqse    xiq_integration     test6

...
Test 1: Confirm Device Type Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test1
...
Test 2: Confirm Device Connection State Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test2
...
Test 3: Confirm Device Management State Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test3
...
Test 4: Confirm Device Function Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test4
...
Test 5: Confirm Device Software Version Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test5
...
Test 6: Confirm Cloud Config Groups Filter
    ...
    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test6
...
#    [Tags]              nightly1    release_testing    csit_tc_8984    xmc_3196    development    xiqse    xiq_integration    device_table    filters    test7
#
#    Switch To Window  ${XIQ_WINDOW_INDEX}
#    Clear All Filters
#    Log To Console  >> Navigating away from and back to the Devices page until APC-51254 is fixed <<
...
Confirm Device MAC Present in XIQ
    ...
    ${search_result}=  Search Device MAC     ${mac}
    Should Be Equal As Integers              ${search_result}    1

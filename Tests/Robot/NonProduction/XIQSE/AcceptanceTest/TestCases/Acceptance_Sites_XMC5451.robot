...
Test 1: Create Site
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test1

    Navigate and Create Site          ${TEST_SITE}

Test 2: Select Site
    [Documentation]     Confirms a site can be selected
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test2
...
Test 3: Discover IP Range
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test3
...
Test 4: Navigate and Confirm IP Address Present in Devices Table
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test4
...
Test 5: Confirm Archive Exists In Tree
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test5
...
Test 6: Confirm Events - Site Discovery
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test6
...
Test 7: Delete Device
    ...
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test7

    Navigate and Delete Device      ${DUT_IP}

Test 8: Delete Site
    [Documentation]     Confirms a site can be deleted
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test8

    Navigate and Delete Site        ${TEST_SITE}

Test 9: Delete Archive
    [Documentation]     Confirms an archive can be deleted
    [Tags]              csit_tc_871    xmc_5451    development    xiqse    acceptance    sites    test9

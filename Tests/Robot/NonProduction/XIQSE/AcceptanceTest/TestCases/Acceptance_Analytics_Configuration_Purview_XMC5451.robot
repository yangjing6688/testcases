...
TEST 1: Create DUT Analytics Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test1
...
TEST 2: Confirm Events - DUT Engine Added
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test2
...
TEST 3: Enforce DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test3

    Navigate and Enforce Analytics Engine            ${DUT_IP}

TEST 4: Confirm Events - DUT Engine Enforced
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test4
...
TEST 5: Poll DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test5
...
TEST 6: Restart Collector on DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test6

    Restart Collector and Confirm Success       ${DUT_IP}

TEST 7: Confirm Events - Restart Collector on DUT Engine
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test7
...
TEST 8: Delete DUT Analytics Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test8

    Navigate and Delete Analytics Engine        ${DUT_IP}

TEST 9: Confirm Events - DUT Engine Deleted
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_873    xmc_5451    development    xiqse    acceptance    analytics    test9

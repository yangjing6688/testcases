...
Test 1: Confirm Log In with Valid Credentials
    ...
    [Tags]              nightly1    xiqse_tc_870    xmc_5451    development    xiqse    acceptance    login    test1
...
Test 2: Confirm Log In with Invalid User
    ...
    [Tags]              nightly1    xiqse_tc_870    xmc_5451    development    xiqse    acceptance    login    test2
...
Test 3: Confirm Log In with Invalid Password
    ...
    [Tags]              nightly1    xiqse_tc_870    xmc_5451    development    xiqse    acceptance    login    test3
...
Test 4: Confirm Log In with Invalid User and Invalid Password
    ...
    [Tags]              nightly1    xiqse_tc_870    xmc_5451    development    xiqse    acceptance    login    test4
...
Test 5: Confirm Log In with Valid Credentials after Invalid Credentials is Successful
    ...
    [Tags]              nightly1    nxiqse_tc_870    xmc_5451    development    xiqse    acceptance    login    test5

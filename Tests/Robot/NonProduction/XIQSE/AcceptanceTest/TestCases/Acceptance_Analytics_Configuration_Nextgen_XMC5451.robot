...
#                 This is qTest TC-872 in the XIQ-SE project.
...
${DUT_IP}                           ${nextgen.ip}
${DUT_NAME}                         ${nextgen.name}
${DUT_PROFILE}                      ${appliance.profile}
${DUT2_IP}                          ${purview.ip}
${DUT2_NAME}                        ${purview.name}
${DUT2_PROFILE}                     ${appliance.profile}
...
Test 1: Create DUT Analytics Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test1
...
Test 2: Confirm Events - DUT Engine Added
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test2
...
Test 3: Enforce DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test3

    Navigate and Enforce Analytics Engine          ${DUT_IP}

Test 4: Confirm Events - DUT Engine Enforced
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test4
...
Test 5: Poll DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test5
...
Test 6: Restart Collector on DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test6

    Restart Collector and Confirm Success       ${DUT_IP}

Test 7: Confirm Events - Restart Collector on DUT Engine
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test7
...
Test 8: Create DUT2 Analytics Engine and Confirm Success
    [Documentation]     Creates an analytics engine
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test8

    Navigate and Add Analytics Engine       ${DUT2_IP}  ${DUT2_NAME}  ${TEST_PROFILE_NAME}

Test 9: Confirm Events - DUT2 Engine Added
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test9

    Navigate to Events and Confirm Success
    Set Event Search String and Confirm Success     Application Analytics Engine Added

    Confirm Event Row Contains Text                 Application Analytics Engine ${DUT2_IP} '${DUT2_NAME}' added
...
Test 10: Enforce All Engines - DUT and DUT2 - and Confirm Success
    ...
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test10

    Navigate and Enforce All Analytics Engines

Test 11: Confirm Events - DUT and DUT2 Engines Enforced
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test11

    Navigate to Events and Confirm Success
    Set Event Search String and Confirm Success     Application Analytics Engine Enforcement

    Confirm Event Row Contains Text                 Application Analytics Engine ${DUT_IP} '${DUT_NAME}' enforced successfully
    Confirm Event Row Contains Text                 Application Analytics Engine ${DUT2_IP} '${DUT2_NAME}' enforced successfully

Test 12: Delete DUT and DUT2 Analytics Engines
    [Documentation]     Confirms a device can be deleted
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test12
...
Test 13: Confirm Events - DUT and DUT2 Engines Deleted
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    xiqse_tc_872    xmc_5451    development    xiqse    acceptance    analytics    test13
    ...
    Confirm Event Row Contains Text                 Application Analytics Engine ${DUT2_IP} '${DUT2_NAME}' deleted
...
Create Analytics Engine CLI Credentials
    ...
    Navigate and Create CLI Credential            ${cli_name}  ${TEST_CLI_USER}  ${TEST_CLI_TYPE}
    ...                                           ${TEST_CLI_LOGIN_PWD}  ${TEST_CLI_ENABLE_PWD}  ${TEST_CLI_CONFIG_PWD}

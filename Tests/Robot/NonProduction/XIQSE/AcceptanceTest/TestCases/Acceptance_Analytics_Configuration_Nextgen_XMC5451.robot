...
Test 1: Create DUT Analytics Engine and Confirm Success
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test1
...
Test 2: Confirm Events - DUT Engine Added
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test2
...
Test 3: Enforce DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test3

    Navigate and Enforce Analytics Engine          ${DUT_IP}

Test 4: Confirm Events - DUT Engine Enforced
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test4
...
Test 5: Poll DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test5
...
Test 6: Restart Collector on DUT Engine and Confirm Success
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test6
...
Test 8: Create DUT2 Analytics Engine and Confirm Success
    [Documentation]     Creates an analytics engine
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test8

    Navigate and Add Analytics Engine       ${DUT2_IP}  ${DUT2_NAME}  ${TEST_PROFILE_NAME}

Test 9: Confirm Events - DUT2 Engine Added
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test9
...
Test 10: Enforce All Engines - DUT and DUT2 - and Confirm Success
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test10

    Navigate and Enforce All Analytics Engines

Test 11: Confirm Events - DUT and DUT2 Engines Enforced
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test11
...
Test 12: Delete DUT and DUT2 Analytics Engines
    ...
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test12
...
Test 13: Confirm Events - DUT and DUT2 Engines Deleted
    [Documentation]     Confirms the events view contains the expected event
    [Tags]              nightly1    tcxe_872    xmc_5451    development    xiqse    acceptance    analytics    test13

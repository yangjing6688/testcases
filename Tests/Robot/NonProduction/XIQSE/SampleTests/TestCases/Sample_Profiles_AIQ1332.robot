...
Test 1: Add CLI Credential
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test1
...
Test 2: Add Duplicate CLI Credential
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test2
...
Test 3: Add SNMP Credential
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test3
...
Test 4: Add Duplicate SNMP Credential
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test4
...
Test 5: Add Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test5
...
Test 6: Add Duplicate Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test6
...
Test 7: Edit Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test7
...
Test 8: Edit Profile With No Changes
    ...
    ...                 (depends on tests 1 and 3, adding CLI and SNMP creds)
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test8
...
Test 9: Delete Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test9
...
Test 10: Delete SNMP Credential (depends on test 3, adding an SNMP credential)
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test10
...
Test 11: Delete CLI Credential
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test11
...
Test 12: Add SNMPv1 Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test12
...
Test 13: Add SNMPv2 Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test13
...
Test 14: Add SNMPv3 Profile
    ...
    [Tags]              xiqse_tc_896    aiq_1332    development    sample    xiqse    profiles    test14

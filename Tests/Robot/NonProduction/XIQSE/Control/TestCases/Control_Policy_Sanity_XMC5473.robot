...
Test 1: Create Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    create_domain    test1
...
Test 2: Assign Device to Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    assign_device_to_domain    test2
...
Test 3: Create Role In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    create_role    test3
...
Test 4: Create Service In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    create_service    test4
...
Test 5: Create Rule In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    create_rule    test5
...
Test 6: Delete Rule In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    delete_rule    test6
...
Test 7: Delete Service In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    delete_service    test7
...
Test 8: Delete Role In The Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    delete_role    test8
...
Test 9: Save Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    save_domain    test9
...
Test 10: Enforce Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    enforce_domain    test10
...
Test 11: Verify Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    verify_domain    test11
...
Test 12: Delete Domain
    ...
    [Tags]              nightly1    tcxe_880    xmc_5473    development    xiqse    acceptance    control    policy    delete_domain    test12

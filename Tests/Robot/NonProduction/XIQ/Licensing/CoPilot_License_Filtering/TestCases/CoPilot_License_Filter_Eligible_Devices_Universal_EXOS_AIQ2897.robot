...
# Description   : Test Suite for testing CoPilot license filter for All CoPilot Eligible Devices - UNIVERSAL EXOS
#               : This is qTest test case TCCS-15106 in the CSIT project.
...
*** Test Cases ***
Test 1: Verify CoPilot Baseline License Counts
    [Documentation]     Confirms license counts are at expected values in XIQ to begin with (nothing consumed)
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test1

    Confirm Entitlement Counts for Feature Matches Expected     ${COPILOT_ENTITLEMENT}     2    0    2

Test 2: Onboard Universal EXOS CoPilot Eligible Device and Verify Success
    [Documentation]     Onboards an EXOS CoPilot eligible device and verifies success
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test2
...
Test 3: Onboard Non-CoPilot Eligible Digital Twin Device and Verify Success
    ...
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test3
...
Test 4: Verify CoPilot Eligible Device Consumes CoPilot License Within Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test4
...
Test 5: Verify Device License and CoPilot Column Values On Devices
    ...
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test5
...
Test 6: Filter For All CoPilot Eligible Devices and Verify Devices Present
    ...
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test6
...
Test 7: Clear Filter For All CoPilot Eligible Devices and Verify Devices Present
    ...
    [Tags]              tccs-15106    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test7
...
Test 8: Delete All Devices and Verify Success
    ...
    [Tags]              tccs-15106    copilot_sanity_testing    copilot_license_testing    xiq-16248    development    xiq    copilot    test8

    Depends On Test     Test 1: Verify CoPilot Baseline License Counts

    Delete All devices and Confirm Success

Test 9: Verify CoPilot License Revoked Within Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
    [Tags]              tccs-15106    copilot_release_testing    copilot_license_testing    xiq-16248    development    xiq    copilot    test9

...
# Description   : Test Suite for testing CoPilot license filter for All CoPilot Eligible Devices - EXOS
#               : This is qTest test case TCCS-15104 in the CSIT project.
...
Test 1: Verify Pilot and CoPilot Baseline License Counts
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test1
...
Test 2: Onboard EXOS CoPilot Eligible Device and Verify Success
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test2
...
Test 3: Onboard Non-CoPilot Eligible Digital Twin Device and Verify Success
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test3
...
Test 4: Verify CoPilot Eligible Device Consumes Pilot And CoPilot Licenses Within Global Settings License Management
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test4
...
Test 5: Verify Device License and CoPilot Column Values On Devices
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test5
...
Test 6: Filter For All CoPilot Eligible Devices and Verify Devices Present
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test6
...
Test 7: Clear Filter For All CoPilot Eligible Devices and Verify Devices Present
    ...
    [Tags]              tccs-15104    copilot_filter_testing    copilot_license_testing    xiq-16248   development    xiq    copilot    test7
...
Test 8: Delete All Devices and Verify Success
    ...
    [Tags]              tccs-15104    copilot_sanity_testing    copilot_license_testing    xiq-16248    development    xiq    copilot    test8
...
Test 9: Verify All Pilot and CoPilot Licenses Revoked Within Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
    [Tags]              tccs-15104    copilot_release_testing    copilot_license_testing    xiq-16248    development    xiq    copilot    test9

...
Test 9: Onboard Fourth Test Device and Verify Device Not Onboarded Due to License Limit Exceeded
    ...
    Onboard New Test Device When License Limit Exceeded      ${DUT4_SERIAL}  ${DUT4_MAKE}  ${LOCATION}  ${DUT4_MAC}
...
Onboard New Test Device When License Limit Exceeded
    ...
    Onboard Device            ${serial}  ${make}  location=${location}  device_mac=${mac}   expect_error=True

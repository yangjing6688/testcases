...
# Description   : Test Suite for testing CoPilot licensing using 1 node EXOS
#               : This is qTest test case tcxm-20884 in the CSIT project.
...
Test 1: Verify Pilot and CoPilot Baseline License Counts
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test1
...
Test 2: Onboard Device and Verify Success
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test2
...
Test 3: Verify Device Consumes Pilot and CoPilot License Within Global Settings License Management
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test3
...
Test 4: Verify Device License and CoPilot Column Values
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test4
...
Test 5: Unmanage Device and Confirm Success
    ...
    [Tags]              tcxm-20884    copilot_release_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test5
...
Test 6: Verify Unmanaged Device Revokes CoPilot and Pilot Licenses in Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
    [Tags]              tcxm-20884    copilot_release_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test6
...
Test 7: Verify Device License and CoPilot Column Values
    ...
    [Tags]              tcxm-20884    copilot_release_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test7
...
Test 8: Manage Device and Confirm Success
    ...
    [Tags]              tcxm-20884    copilot_release_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test8
...
Test 9: Verify Managed Device Consumes Pilot and CoPilot License Within Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test9
...
Test 10: Verify Managed Device License and CoPilot Column Values
    [Documentation]     Confirms the Device License and CoPilot columns to verify device consumed the appropriate license or not
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test10
...
Test 11: Delete Device and Verify Success
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test11
...
Test 12: Verify Pilot and CoPilot Licenses Revoked Within Global Settings License Management
    ...
    [Tags]              tcxm-20884    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test12

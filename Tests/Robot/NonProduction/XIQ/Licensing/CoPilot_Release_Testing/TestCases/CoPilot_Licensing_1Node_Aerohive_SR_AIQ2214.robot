...
# Description   : Test Suite for testing CoPilot licensing using 1 node Aerohive Switch
#               : This is qTest test case TCXM-20890 in the CSIT project.
...
Test 1: Verify Pilot and CoPilot Baseline License Counts
    ...
    [Tags]              tcxm-20890    copilot_sanity_testing    copilot_license_testing    aiq-2214    development    xiq    copilot    test1
...
Test 3: Verify Device Consumes Pilot License but Not CoPilot License Within Global Settings License Management
...
Test 6: Verify Unmanaged Device Revokes Pilot License in Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
...
Test 9: Verify Device Consumes Pilot License but Not CoPilot License Within Global Settings License Management
    [Documentation]     Confirms the license counts for Pilot and CoPilot within Global Settings->License Management
...
Test 10: Verify Device License and CoPilot Column Values
    [Documentation]     Confirms the Device License and CoPilot columns to verify device consumed the appropriate license or not

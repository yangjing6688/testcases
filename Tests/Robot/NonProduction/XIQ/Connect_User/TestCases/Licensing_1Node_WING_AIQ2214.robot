...
# Description   : Test Suite for testing Connect user licensing using 1 node WiNG
#               : This is qTest test case tccs-13710 in the CSIT project.
...
Test 1: Onboard Device and Verify Success
    ...
    [Tags]              tccs-13710    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test1
...
Test 2: Verify Device License and CoPilot Column Values
    ...
    [Tags]              tccs-13710    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test2
...
Test 3: Unmanage Device and Confirm Success
    ...
    [Tags]              tccs-13710    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test3
...
Test 4: Verify Unmanaged Device License and CoPilot Column Values
    [Documentation]     Confirms the Device License and CoPilot columns to verify they are set to None
    [Tags]              tccs-13710    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test4
...
Test 5: Manage Device and Confirm Success
    ...
    [Tags]              tccs-13710    known_issue    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test5
...
Test 6: Verify Managed Device License and CoPilot Column Values
    [Documentation]     Confirms the Device License and CoPilot columns to verify they are set to None
    [Tags]              tccs-13710    known_issue    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test6
...
Test 7: Delete Device and Verify Success
    ...
    [Tags]              tccs-13710    connect_release_testing    connect_sanity_testing    aiq-2214    development    xiq    copilot    test7

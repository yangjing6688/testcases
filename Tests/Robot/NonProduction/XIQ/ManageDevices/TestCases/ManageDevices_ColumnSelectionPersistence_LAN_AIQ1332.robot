...
Make Changes to the Column Picker Selections
    ...
    [Tags]              tccs_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test1
...
Confirm Column Picker Selections Persist For User in New Browser Session
    ...
    [Tags]              tccs_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test2
...
Confirm Column Picker Selections Do Not Apply To Other View Types
    ...
    [Tags]              known_issue    tccs_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test3
...
Confirm Column Picker Selections Persist For Same User on Different PC
    ...
    [Tags]              tccs_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test4
...
Confirm Column Picker Selections Do Not Persist For Different User
    ...
    [Tags]              tccs_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test5

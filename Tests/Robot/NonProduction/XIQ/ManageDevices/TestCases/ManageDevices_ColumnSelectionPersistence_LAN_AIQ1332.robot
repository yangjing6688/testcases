...
# Description   : Verifies the column selection persistence functionality works as expected in the LAN view
#                 of Manage> Devices.
#                 This is qTest test case TC-6914 in the CSIT project.
#
...
Make Changes to the Column Picker Selections
    ...
    [Tags]              csit_tc_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test1
...
Confirm Column Picker Selections Persist For User in New Browser Session
    ...
    [Tags]              csit_tc_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test2
...
Confirm Column Picker Selections Do Not Apply To Other View Types
    ...
    [Tags]              known_issue    csit_tc_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test3
    ...
    Run Keyword If  '${VIEW_TYPE}'.startswith('LAN')
    ...  Confirm Non LAN View At Default Column Selections
...
Confirm Column Picker Selections Persist For Same User on Different PC
    ...
    [Tags]              csit_tc_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test4
...
Confirm Column Picker Selections Do Not Persist For Different User
    ...
    [Tags]              csit_tc_6914   aiq_1332    development    xiq    manage_devices    column_persistence_lan    test5

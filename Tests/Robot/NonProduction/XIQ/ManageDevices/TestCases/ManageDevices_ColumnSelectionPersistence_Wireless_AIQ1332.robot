...
# Description   : Verifies the column selection persistence functionality works as expected in the Wireless view
#                 of Manage> Devices.
#                 This is qTest test case TC-7070 in the CSIT project.
#
...
Confirm Column Picker Selections Do Not Apply To Other View Types
    ...
    Run Keyword If  '${VIEW_TYPE}'.startswith('Wireless')
    ...  Confirm Non Wireless View At Default Column Selections
